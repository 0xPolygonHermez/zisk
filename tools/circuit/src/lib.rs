...
mod tests {
    ...
    fn test_simple_circuit() {
        ...
        for (i, input) in inputs.iter().enumerate() {
            ...
            state.and(state.gate_config.zero_ref, PinId::B, state.sin_refs[0], PinId::A, free_ref1);
            ...
            state.gates[output_ref as usize].pins[PinId::A].bit = state.gates[free_ref2 as usize]
                .pins[PinId::C]
                .bit;
