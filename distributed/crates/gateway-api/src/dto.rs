//! Domain types shared across gateway and SDK.
//!
//! These types are the canonical representation of gateway API concepts.
...
/// Returned by the gateway `wait_job_result` long-poll.
#[derive(Debug)]
