            ...
            Some(execute_task_response::ResultData::Challenges(challenges_list)) => {
                ...
                let stream_timing = challenges_list.stream_timing.map(|st| StreamTimingDto {
                    inputs_timing: st.inputs_timing.map(|it| StreamTimingStatsDto {
                        ...
                        first_received_at: it.first_received_at,
                        last_received_at: it.last_received_at,
                        avg_interarrival_time: it.avg_interarrival_time,
                        max_interarrival_time: it.max_interarrival_time,
                        total_interarrival_time: it.total_interarrival_time,
                    }),
                    hints_timing: st.hints_timing.map(|ht| StreamTimingStatsDto {
                        ...
                        first_received_at: ht.first_received_at,
                        last_received_at: ht.last_received_at,
                        avg_interarrival_time: ht.avg_interarrival_time,
                        max_interarrival_time: ht.max_interarrival_time,
                        total_interarrival_time: ht.total_interarrival_time,
                    }),
                });
