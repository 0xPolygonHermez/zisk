...
pub struct Coordinator {
    ...
    running_jobs: RwLock<HashMap<JobId, Job>>,
...
impl Coordinator {
    ...
    pub async fn start_proof(
        ...
        let job = self.create_job(block_id, required_compute_capacity, input_path).await?;
        ...
        self.running_jobs.write().await.insert(job_id.clone(), job);
