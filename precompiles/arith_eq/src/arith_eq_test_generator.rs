...
fn main() {
    ...
    code += "use ziskos::syscalls::{arith256::*, arith256_mod::*,secp256k1_add::*, secp256k1_dbl::*,point256::*};\n";
    code += "use ziskos::read_input;\n\n\n";
    code += "fn main() {\n";
    code += "\t// Get the input from ziskos\n";
    code += "\tlet _input: Vec<u8> = read_input();\n\n";
