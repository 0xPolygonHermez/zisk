//! The `Arith256Counter` module defines a counter for tracking arith256-related operations
//! sent over the data bus. It connects to the bus and gathers metrics for specific
//! `ZiskOperationType::Arith256` instructions.
...
/// The `Arith256Counter` struct represents a counter that monitors and measures
/// arith256-related operations on the data bus.
///
...
pub struct Arith256CounterInputGen {
    /// Arith256 counter.
    counter: Counter,
...
const ARITH_256_MEM_CONFIG: Arith256MemInputConfig = Arith256MemInputConfig {
...
const ARITH_256_MOD_MEM_CONFIG: Arith256MemInputConfig = Arith256MemInputConfig {
    indirect_params: true,
    rewrite_params: false,
    read_params: 4,
    write_params: 1,
...
const SECP256K1_ADD_MEM_CONFIG: Arith256MemInputConfig = Arith256MemInputConfig {
    indirect_params: true,
    rewrite_params: true,
    read_params: 2,
    write_params: 1,
...
const SECP256K1_DBL_MEM_CONFIG: Arith256MemInputConfig = Arith256MemInputConfig {
...
impl Arith256CounterInputGen {
    /// Creates a new instance of `Arith256Counter`.
    ///
    /// # Arguments
    ...
    ///
    /// # Returns
    /// A new `Arith256Counter` instance.
...
impl Metrics for Arith256CounterInputGen {
...
impl Add for Arith256CounterInputGen {
    type Output = Arith256CounterInputGen;
    ...
    fn add(self, other: Self) -> Arith256CounterInputGen {
        Arith256CounterInputGen { counter: &self.counter + &other.counter, mode: self.mode }
    }
}

impl BusDevice<u64> for Arith256CounterInputGen {
