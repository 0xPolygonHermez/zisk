...
pub struct Dma64AlignedSM<F: PrimeField64, RC: RangeChecker> {
...
impl<F: PrimeField64, RC: RangeChecker> Dma64AlignedSM<F, RC> {
...
impl<F: PrimeField64, RC: RangeChecker> Dma64AlignedModule<F> for Dma64AlignedSM<F, RC> {
