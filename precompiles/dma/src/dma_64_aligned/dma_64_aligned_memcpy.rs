...
pub struct Dma64AlignedMemCpySM<F: PrimeField64, RC: RangeChecker> {
...
impl<F: PrimeField64, RC: RangeChecker> Dma64AlignedMemCpySM<F, RC> {
...
impl<F: PrimeField64, RC: RangeChecker> Dma64AlignedModule<F> for Dma64AlignedMemCpySM<F, RC> {
