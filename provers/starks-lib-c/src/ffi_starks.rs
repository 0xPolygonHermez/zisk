...
pub fn set_hint_field_c(
    ...
    unsafe {
        let field_name = CString::new(hint_field_name).unwrap();
        set_hint_field(p_setup_ctx, buffer, subproof_values, values, hint_id, field_name.as_ptr() as *mut std::os::raw::c_char)
    }
}
...
#[cfg(not(feature = "no_lib_link"))]
pub fn compute_evals_c(p_stark: *mut c_void, buffer: *mut c_void, challenges: *mut c_void, evals: *mut c_void, pProof: *mut c_void) {
    unsafe {
...
pub fn print_by_name_c(
    ...
    unsafe {
        print_by_name(p_setup_ctx, buffer, public_inputs, challenges, subproof_values, name_ptr, lengths, first_print_value, last_print_value, return_values)
    }
}
...
#[cfg(feature = "no_lib_link")]
pub fn compute_evals_c(_p_stark: *mut c_void, _buffer: *mut c_void, _challenges: *mut c_void, _evals: *mut c_void, _pProof: *mut c_void) {
