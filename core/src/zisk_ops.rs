...
use crate::{
    ...
    ARITH_EQ_COST, BABYJUBJUB_COST, BINARY_ADD_COST, BINARY_COST, BINARY_E_COST, BLAKE2_COST,
    ...
    INPUT_ADDR, INTERNAL_COST, KECCAK_COST, M64, MAX_INPUT_SIZE, POSEIDON2_COST, REG_A0,
    SHA256_COST, SYS_ADDR,
};
...
pub fn opc_babyjubjub_add(ctx: &mut InstContext) {
    ...
    if ctx.emulation_mode != EmulationMode::ConsumeMemReads {
        ...
        precompiles_helpers::babyjubjub_add(p1, p2, &mut p3);
