...
use crate::{
    InstContext, PrecompiledEmulationMode, ZiskOperationType, ZiskRequiredOperation, M64, REG_A0,
    SYS_ADDR,
};
...
define_ops! {
    ...
    (SignExtendB, "signextend_b", BinaryE, 109, 0x37, 0, opc_signextend_b, op_signextend_b),
    (SignExtendH, "signextend_h", BinaryE, 109, 0x38, 0, opc_signextend_h, op_signextend_h),
    (SignExtendW, "signextend_w", BinaryE, 109, 0x39, 0, opc_signextend_w, op_signextend_w),
    (Add, "add", Binary, 77, 0x0c, 0, opc_add, op_add),
    (AddW, "add_w", Binary, 77, 0x2c, 0, opc_add_w, op_add_w),
    (Sub, "sub", Binary, 77, 0x0d, 0, opc_sub, op_sub),
    (SubW, "sub_w", Binary, 77, 0x2d, 0, opc_sub_w, op_sub_w),
    (Sll, "sll", BinaryE, 109, 0x31, 0, opc_sll, op_sll),
    (SllW, "sll_w", BinaryE, 109, 0x34, 0, opc_sll_w, op_sll_w),
    (Sra, "sra", BinaryE, 109, 0x33, 0, opc_sra, op_sra),
    (Srl, "srl", BinaryE, 109, 0x32, 0, opc_srl, op_srl),
    (SraW, "sra_w", BinaryE, 109, 0x36, 0, opc_sra_w, op_sra_w),
    (SrlW, "srl_w", BinaryE, 109, 0x35, 0, opc_srl_w, op_srl_w),
    (Eq, "eq", Binary, 77, 0x0b, 0, opc_eq, op_eq),
    (EqW, "eq_w", Binary, 77, 0x2b, 0, opc_eq_w, op_eq_w),
    (Ltu, "ltu", Binary, 77, 0x08, 0, opc_ltu, op_ltu),
    (Lt, "lt", Binary, 77, 0x09, 0, opc_lt, op_lt),
    (LtuW, "ltu_w", Binary, 77, 0x28, 0, opc_ltu_w, op_ltu_w),
    (LtW, "lt_w", Binary, 77, 0x29, 0, opc_lt_w, op_lt_w),
    (Leu, "leu", Binary, 77, 0x0e, 0, opc_leu, op_leu),
    (Le, "le", Binary, 77, 0x0f, 0, opc_le, op_le),
    (LeuW, "leu_w", Binary, 77, 0x2e, 0, opc_leu_w, op_leu_w),
    (LeW, "le_w", Binary, 77, 0x2f, 0, opc_le_w, op_le_w),
    (And, "and", Binary, 77, 0x10, 0, opc_and, op_and),
    (Or, "or", Binary, 77, 0x11, 0, opc_or, op_or),
    (Xor, "xor", Binary, 77, 0x12, 0, opc_xor, op_xor),
    (Mulu, "mulu", ArithAm32, 97, 0xb0, 0, opc_mulu, op_mulu),
    (Muluh, "muluh", ArithAm32, 97, 0xb1, 0, opc_muluh, op_muluh),
    (Mulsuh, "mulsuh", ArithAm32, 97, 0xb3, 0, opc_mulsuh, op_mulsuh),
    (Mul, "mul", ArithAm32, 97, 0xb4, 0, opc_mul, op_mul),
    (Mulh, "mulh", ArithAm32, 97, 0xb5, 0, opc_mulh, op_mulh),
    (MulW, "mul_w", ArithAm32, 44, 0xb6, 0, opc_mul_w, op_mul_w),
    (Divu, "divu", ArithAm32, 174, 0xb8, 0, opc_divu, op_divu),
    (Remu, "remu", ArithAm32, 174, 0xb9, 0, opc_remu, op_remu),
    (Div, "div", ArithAm32, 174, 0xba, 0, opc_div, op_div),
    (Rem, "rem", ArithAm32, 174, 0xbb, 0, opc_rem, op_rem),
    (DivuW, "divu_w", ArithA32, 136, 0xbc, 0, opc_divu_w, op_divu_w),
    (RemuW, "remu_w", ArithA32, 136, 0xbd, 0, opc_remu_w, op_remu_w),
    (DivW, "div_w", ArithA32, 136, 0xbe, 0, opc_div_w, op_div_w),
    (RemW, "rem_w", ArithA32, 136, 0xbf, 0, opc_rem_w, op_rem_w),
    (Minu, "minu", Binary, 77, 0x02, 0, opc_minu, op_minu),
    (Min, "min", Binary, 77, 0x03, 0, opc_min, op_min),
    (MinuW, "minu_w", Binary, 77, 0x22, 0, opc_minu_w, op_minu_w),
    (MinW, "min_w", Binary, 77, 0x23, 0, opc_min_w, op_min_w),
    (Maxu, "maxu", Binary, 77, 0x04, 0, opc_maxu, op_maxu),
    (Max, "max", Binary, 77, 0x05, 0, opc_max, op_max),
    (MaxuW, "maxu_w", Binary, 77, 0x24, 0, opc_maxu_w, op_maxu_w),
