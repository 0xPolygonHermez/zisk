...
define_ops! {
    ...
    (Andn, "andn", Binary, BINARY_E_COST, 0x33, 0, 0, opc_andn, op_andn, ops_none),
    (Orn, "orn", Binary, BINARY_E_COST, 0x34, 0, 0, opc_orn, op_orn, ops_none),
    (Xnor, "xnor", Binary, BINARY_E_COST, 0x35, 0, 0, opc_xnor, op_xnor, ops_none),
    (Pack, "pack", Binary, BINARY_E_COST, 0x36, 0, 0, opc_pack, op_pack, ops_none),
    (PackH, "pack_h", Binary, BINARY_E_COST, 0x37, 0, 0, opc_pack_h, op_pack_h, ops_none),
    (PackW, "pack_w", Binary, BINARY_E_COST, 0x38, 0, 0, opc_pack_w, op_pack_w, ops_none),
