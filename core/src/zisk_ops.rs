...
define_ops! {
    ...
    (Rev8, "rev8", BinaryE, BINARY_E_COST, 0xc0, 0, 0, opc_rev8, op_rev8, ops_none),
    (Brev8, "brev8", BinaryE, BINARY_E_COST, 0xc1, 0, 0, opc_brev8, op_brev8, ops_none),
    (Andn, "andn", Binary, BINARY_COST, 0xc2, 0, 0, opc_andn, op_andn, ops_none),
    (Orn, "orn", Binary, BINARY_COST, 0xc3, 0, 0, opc_orn, op_orn, ops_none),
    (Xnor, "xnor", Binary, BINARY_COST, 0xc4, 0, 0, opc_xnor, op_xnor, ops_none),
    (Pack, "pack", Binary, BINARY_COST, 0xc5, 0, 0, opc_pack, op_pack, ops_none),
    (PackH, "pack_h", Binary, BINARY_COST, 0xc6, 0, 0, opc_pack_h, op_pack_h, ops_none),
    (PackW, "pack_w", Binary, BINARY_COST, 0xc7, 0, 0, opc_pack_w, op_pack_w, ops_none),
    (Rol, "rol", BinaryE, BINARY_E_COST, 0xc8, 0, 0, opc_rol, op_rol, ops_none),
    (RolW, "rol_w", BinaryE, BINARY_E_COST, 0xc9, 0, 0, opc_rol_w, op_rol_w, ops_none),
    (Ror, "ror", BinaryE, BINARY_E_COST, 0xca, 0, 0, opc_ror, op_ror, ops_none),
    (RorW, "ror_w", BinaryE, BINARY_E_COST, 0xcb, 0, 0, opc_ror_w, op_ror_w, ops_none),
