...
impl ZiskOperations {
    ...
    pub fn new() -> ZiskOperations {
        ...
        let ops: Vec<ZiskOperation> = vec![
            ...
            ZiskOperation { n: "signextend_b", t: "b32", c: 0x02, f: op_signextend_b },
            ZiskOperation { n: "signextend_h", t: "b32", c: 0x03, f: op_signextend_h },
            ZiskOperation { n: "signextend_w", t: "b32", c: 0x04, f: op_signextend_w },
            ZiskOperation { n: "add", t: "b", c: 0x10, f: op_add },
            ZiskOperation { n: "add_w", t: "b32", c: 0x14, f: op_add_w },
            ZiskOperation { n: "sub", t: "b", c: 0x20, f: op_sub },
            ZiskOperation { n: "sub_w", t: "b32", c: 0x24, f: op_sub_w },
            ZiskOperation { n: "sll", t: "b", c: 0x30, f: op_sll },
            ZiskOperation { n: "sll_w", t: "b32", c: 0x34, f: op_sll_w },
            ZiskOperation { n: "sra", t: "b", c: 0x40, f: op_sra },
            ZiskOperation { n: "srl", t: "b", c: 0x41, f: op_srl },
            ZiskOperation { n: "sra_w", t: "b32", c: 0x44, f: op_sra_w },
            ZiskOperation { n: "srl_w", t: "b32", c: 0x45, f: op_srl_w },
            ZiskOperation { n: "eq", t: "b", c: 0x50, f: op_eq },
            ZiskOperation { n: "eq_w", t: "b32", c: 0x54, f: op_eq_w },
            ZiskOperation { n: "ltu", t: "b", c: 0x60, f: op_ltu },
            ZiskOperation { n: "lt", t: "b", c: 0x61, f: op_lt },
            ZiskOperation { n: "ltu_w", t: "b32", c: 0x64, f: op_ltu_w },
            ZiskOperation { n: "lt_w", t: "b32", c: 0x65, f: op_lt_w },
            ZiskOperation { n: "leu", t: "b", c: 0x70, f: op_leu },
            ZiskOperation { n: "le", t: "b", c: 0x71, f: op_le },
            ZiskOperation { n: "leu_w", t: "b32", c: 0x74, f: op_leu_w },
            ZiskOperation { n: "le_w", t: "b32", c: 0x75, f: op_le_w },
            ZiskOperation { n: "and", t: "b", c: 0x80, f: op_and },
            ZiskOperation { n: "or", t: "b", c: 0x90, f: op_or },
            ZiskOperation { n: "xor", t: "b", c: 0xa0, f: op_xor },
            ZiskOperation { n: "mulu", t: "a", c: 0xb0, f: op_mulu },
            ZiskOperation { n: "mul", t: "a", c: 0xb1, f: op_mul },
            ZiskOperation { n: "mul_w", t: "a32", c: 0xb5, f: op_mul_w },
            ZiskOperation { n: "muluh", t: "a", c: 0xb8, f: op_muluh },
            ZiskOperation { n: "mulh", t: "a", c: 0xb9, f: op_mulh },
            ZiskOperation { n: "mulsuh", t: "a", c: 0xbb, f: op_mulsuh },
            ZiskOperation { n: "divu", t: "a", c: 0xc0, f: op_divu },
            ZiskOperation { n: "div", t: "a", c: 0xc1, f: op_div },
            ZiskOperation { n: "divu_w", t: "a32", c: 0xc4, f: op_divu_w },
            ZiskOperation { n: "div_w", t: "a32", c: 0xc5, f: op_div_w },
            ZiskOperation { n: "remu", t: "a", c: 0xc8, f: op_remu },
            ZiskOperation { n: "rem", t: "a", c: 0xc9, f: op_rem },
            ZiskOperation { n: "remu_w", t: "a32", c: 0xcc, f: op_remu_w },
            ZiskOperation { n: "rem_w", t: "a32", c: 0xcd, f: op_rem_w },
            ZiskOperation { n: "minu", t: "b", c: 0xd0, f: op_minu },
            ZiskOperation { n: "min", t: "b", c: 0xd1, f: op_min },
            ZiskOperation { n: "minu_w", t: "b32", c: 0xd4, f: op_minu_w },
            ZiskOperation { n: "min_w", t: "b32", c: 0xd5, f: op_min_w },
            ZiskOperation { n: "maxu", t: "b", c: 0xe0, f: op_maxu },
            ZiskOperation { n: "max", t: "b", c: 0xe1, f: op_max },
            ZiskOperation { n: "maxu_w", t: "b32", c: 0xe4, f: op_maxu_w },
            ZiskOperation { n: "max_w", t: "b32", c: 0xe5, f: op_max_w },
        ];
...
pub fn op_from_str(op: &str) -> ZiskOperation {
    match op {
        ...
        "add" => ZiskOperation { n: "add", t: "b", c: 0x10, f: op_add },
        "add_w" => ZiskOperation { n: "add_w", t: "b32", c: 0x14, f: op_add_w },
        "sub" => ZiskOperation { n: "sub", t: "b", c: 0x20, f: op_sub },
        "sub_w" => ZiskOperation { n: "sub_w", t: "b32", c: 0x24, f: op_sub_w },
        "sll" => ZiskOperation { n: "sll", t: "b", c: 0x30, f: op_sll },
        "sll_w" => ZiskOperation { n: "sll_w", t: "b32", c: 0x34, f: op_sll_w },
        "sra" => ZiskOperation { n: "sra", t: "b", c: 0x40, f: op_sra },
        "srl" => ZiskOperation { n: "srl", t: "b", c: 0x41, f: op_srl },
        "sra_w" => ZiskOperation { n: "sra_w", t: "b32", c: 0x44, f: op_sra_w },
        "srl_w" => ZiskOperation { n: "srl_w", t: "b32", c: 0x45, f: op_srl_w },
        "eq" => ZiskOperation { n: "eq", t: "b", c: 0x50, f: op_eq },
        "eq_w" => ZiskOperation { n: "eq_w", t: "b32", c: 0x54, f: op_eq_w },
        "ltu" => ZiskOperation { n: "ltu", t: "b", c: 0x60, f: op_ltu },
        "lt" => ZiskOperation { n: "lt", t: "b", c: 0x61, f: op_lt },
        "ltu_w" => ZiskOperation { n: "ltu_w", t: "b32", c: 0x64, f: op_ltu_w },
        "lt_w" => ZiskOperation { n: "lt_w", t: "b32", c: 0x65, f: op_lt_w },
        "leu" => ZiskOperation { n: "leu", t: "b", c: 0x70, f: op_leu },
        "le" => ZiskOperation { n: "le", t: "b", c: 0x71, f: op_le },
        "leu_w" => ZiskOperation { n: "leu_w", t: "b32", c: 0x74, f: op_leu_w },
        "le_w" => ZiskOperation { n: "le_w", t: "b32", c: 0x75, f: op_le_w },
        "and" => ZiskOperation { n: "and", t: "b", c: 0x80, f: op_and },
        "or" => ZiskOperation { n: "or", t: "b", c: 0x90, f: op_or },
        "xor" => ZiskOperation { n: "xor", t: "b", c: 0xa0, f: op_xor },
        "mulu" => ZiskOperation { n: "mulu", t: "a", c: 0xb0, f: op_mulu },
        "mul" => ZiskOperation { n: "mul", t: "a", c: 0xb1, f: op_mul },
        "mul_w" => ZiskOperation { n: "mul_w", t: "a32", c: 0xb5, f: op_mul_w },
        "muluh" => ZiskOperation { n: "muluh", t: "a", c: 0xb8, f: op_muluh },
        "mulh" => ZiskOperation { n: "mulh", t: "a", c: 0xb9, f: op_mulh },
        "mulsuh" => ZiskOperation { n: "mulsuh", t: "a", c: 0xbb, f: op_mulsuh },
        "divu" => ZiskOperation { n: "divu", t: "a", c: 0xc0, f: op_divu },
        "div" => ZiskOperation { n: "div", t: "a", c: 0xc1, f: op_div },
        "divu_w" => ZiskOperation { n: "divu_w", t: "a32", c: 0xc4, f: op_divu_w },
        "div_w" => ZiskOperation { n: "div_w", t: "a32", c: 0xc5, f: op_div_w },
        "remu" => ZiskOperation { n: "remu", t: "a", c: 0xc8, f: op_remu },
        "rem" => ZiskOperation { n: "rem", t: "a", c: 0xc9, f: op_rem },
        "remu_w" => ZiskOperation { n: "remu_w", t: "a32", c: 0xcc, f: op_remu_w },
        "rem_w" => ZiskOperation { n: "rem_w", t: "a32", c: 0xcd, f: op_rem_w },
        "minu" => ZiskOperation { n: "minu", t: "b", c: 0xd0, f: op_minu },
        "min" => ZiskOperation { n: "min", t: "b", c: 0xd1, f: op_min },
        "minu_w" => ZiskOperation { n: "minu_w", t: "b32", c: 0xd4, f: op_minu_w },
        "min_w" => ZiskOperation { n: "min_w", t: "b32", c: 0xd5, f: op_min_w },
        "maxu" => ZiskOperation { n: "maxu", t: "b", c: 0xe0, f: op_maxu },
        "max" => ZiskOperation { n: "max", t: "b", c: 0xe1, f: op_max },
        "maxu_w" => ZiskOperation { n: "maxu_w", t: "b32", c: 0xe4, f: op_maxu_w },
        "max_w" => ZiskOperation { n: "max_w", t: "b32", c: 0xe5, f: op_max_w },
