...
const OP_TABLE_OFFSETS: [usize; 6] = [0, 475136, 1785856, 0, 1786880, 1840544];
...
impl BinaryExtensionFrops {
    ...
    pub fn build_table(&mut self) {
        // op sll
        {
            ...
            // mid_box: a >= 0x100F000 && a < 0x1011000 && b >= 31 && b < 57
            for a in 0x100F000..0x1011000 {
                for b in 0x1F..0x39 {
                    ops.push([a, b]);
                }
            }
        ...
        // op srl_w
        {
            ...
            // mid_box: a >= 0xFFFFA000 && a < 0x100000000 && b == 24
            for a in 0xFFFFA000..0x100000000 {
                for b in 0x18..0x19 {
                    ops.push([a, b]);
                }
            }
    ...
    pub fn is_frequent_op(op: u8, a: u64, b: u64) -> bool {
        match op {
            OP_SLL => a < 4096 && b < 64 || a >= 0x100F000 && a < 0x1011000 && b >= 31 && b < 57,
            OP_SRL => a < 4096 && b < 64 || a >= 4096 && a < 20480 && b < 64,
            OP_SRA => {
                a >= 0x6000000000000000 && a < 0x6000000000001000 && (a & 7) == 0 && b == 56
                    || a >= 0x6100000000000000 && a < 0x6100000000001000 && (a & 7) == 0 && b == 56
            }
            OP_SRLW => a < 909 && b < 32 || a >= 0xFFFFA000 && a < 0x100000000 && b == 24,
            OP_SRAW => a < 116 && b < 32 || a >= 0xFFFFFFFFFFFFFF08 && b < 32,
            _ => false,
        }
    }
    ...
    pub fn get_row(op: u8, a: u64, b: u64) -> usize {
        let relative_offset = match op {
            OP_SLL => {
                if a < 4096 && b < 64 {
                    (a * 64 + b) as usize
                } else if a >= 0x100F000 && a < 0x1011000 && b >= 31 && b < 57 {
                    ((a - 0x100F000) * 26 + (b - 0x1F)) as usize + 262144
                } else {
                    Self::NO_FROPS
                }
            }
            ...
            OP_SRA => {
                if a >= 0x6000000000000000 && a < 0x6000000000001000 && (a & 7) == 0 && b == 56 {
                    ((a - 0x6000000000000000) / 8) as usize
                } else if a >= 0x6100000000000000
                    && a < 0x6100000000001000
                    && (a & 7) == 0
                    && b == 56
                {
                    ((a - 0x6100000000000000) / 8) as usize + 512
                } else {
                    Self::NO_FROPS
                }
            }
            OP_SRLW => {
                if a < 909 && b < 32 {
                    (a * 32 + b) as usize
                } else if a >= 0xFFFFA000 && a < 0x100000000 && b == 24 {
                    (a - 0xFFFFA000) as usize + 29088
                } else {
                    Self::NO_FROPS
                }
            }
            OP_SRAW => {
                if a < 116 && b < 32 {
                    ...
                    ((a - 0xFFFFFFFFFFFFFF08) * 32 + b) as usize + 3712
                } else {
                    Self::NO_FROPS
                }
            }
