...
pub struct MemAlignByteInstance<F: PrimeField64, RC: RangeChecker> {
    /// Instance context
    ictx: InstanceCtx,
...
impl<F: PrimeField64, RC: RangeChecker> MemAlignByteInstance<F, RC> {
...
impl<F: PrimeField64, RC: RangeChecker> Instance<F> for MemAlignByteInstance<F, RC> {
    fn compute_witness(
        &self,
        _pctx: &ProofCtx<F>,
        _sctx: &SetupCtx<F>,
