...
uint32_t MemCounter::addr_to_offset(uint32_t addr, uint32_t chunk_id) {
    switch((uint8_t)((addr >> 24) & 0xFC)) {
        ...
        // RAM: 512 MB 
        case (RAM_ADDR_MASK + 0x00): return ((addr - (RAM_ADDR + 0x00000000)) >> (ADDR_LOW_BITS)) + 6 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x04): return ((addr - (RAM_ADDR + 0x04000000)) >> (ADDR_LOW_BITS)) + 7 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x08): return ((addr - (RAM_ADDR + 0x08000000)) >> (ADDR_LOW_BITS)) + 8 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x0C): return ((addr - (RAM_ADDR + 0x0C000000)) >> (ADDR_LOW_BITS)) + 9 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x10): return ((addr - (RAM_ADDR + 0x10000000)) >> (ADDR_LOW_BITS)) + 10 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x14): return ((addr - (RAM_ADDR + 0x14000000)) >> (ADDR_LOW_BITS)) + 11 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x18): return ((addr - (RAM_ADDR + 0x18000000)) >> (ADDR_LOW_BITS)) + 12 * ADDR_PAGE_SIZE;
        case (RAM_ADDR_MASK + 0x1C): return ((addr - (RAM_ADDR + 0x1C000000)) >> (ADDR_LOW_BITS)) + 13 * ADDR_PAGE_SIZE;
    }
    std::ostringstream msg;
...
uint32_t MemCounter::addr_to_page(uint32_t addr, uint32_t chunk_id) {
    switch((uint8_t)((addr >> 24) & 0xFC)) {
        ...
        // RAM: 512 MB 
        case (RAM_ADDR_MASK + 0x00): return 6;
        case (RAM_ADDR_MASK + 0x04): return 7;
        case (RAM_ADDR_MASK + 0x08): return 8;
        case (RAM_ADDR_MASK + 0x0C): return 9;
        case (RAM_ADDR_MASK + 0x10): return 10;
        case (RAM_ADDR_MASK + 0x14): return 11;
        case (RAM_ADDR_MASK + 0x18): return 12;
        case (RAM_ADDR_MASK + 0x1C): return 13;
    }
    std::ostringstream msg;
...
uint32_t MemCounter::page_to_addr(uint8_t page) {
    switch(page) {
        ...
        // RAM: 512 MB 
        case 6: return (RAM_ADDR + 0x00000000);
        case 7: return (RAM_ADDR + 0x04000000);
        case 8: return (RAM_ADDR + 0x08000000);
        case 9: return (RAM_ADDR + 0x0C000000);
        case 10: return (RAM_ADDR + 0x10000000);
        case 11: return (RAM_ADDR + 0x14000000);
        case 12: return (RAM_ADDR + 0x18000000);
        case 13: return (RAM_ADDR + 0x1C000000);
