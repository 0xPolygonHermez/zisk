...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct MemAlignChunkCounters {
    _unused: [u8; 0],
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn wait_mem_align_counters(mcp: *mut MemCountAndPlan);
}
unsafe extern "C" {
    pub fn get_mem_segment_count(mcp: *mut MemCountAndPlan, mem_id: u32) -> u32;
}
unsafe extern "C" {
    pub fn get_mem_segment_offset_changes(
        mcp: *mut MemCountAndPlan,
        mem_id: u32,
        segment_id: u32,
        offsets_base_addr_out: *mut u32,
        range_slots_out: *mut u32,
        values_out: *mut *const u32,
        count: *mut u32,
    ) -> *const u32;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn get_mem_align_counters(
        mcp: *mut MemCountAndPlan,
        count: *mut u32,
    ) -> *const MemAlignChunkCounters;
}
unsafe extern "C" {
    pub fn get_mem_align_total_counters(mcp: *mut MemCountAndPlan) -> *const MemAlignChunkCounters;
}
unsafe extern "C" {
