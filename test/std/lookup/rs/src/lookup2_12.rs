    ...
    Standard: Distribution<F>,
{
    ...
    pub fn execute(&self, pctx: Arc<ProofCtx<F>>, ectx: Arc<ExecutionCtx>, _sctx: Arc<SetupCtx>) {
        ...
        let air_instance =
            AirInstance::new(LOOKUP_AIRGROUP_ID, LOOKUP_2_12_AIR_IDS[0], None, buffer);
    ...
    Standard: Distribution<F>,
{
    fn calculate_witness(
        ...
        if stage == 1 {
            ...
            let num_rows = pctx
                .pilout
                .get_air(LOOKUP_AIRGROUP_ID, LOOKUP_2_12_AIR_IDS[0])
                .num_rows();
            let mut trace =
                Lookup2_122Trace::map_buffer(buffer.as_mut_slice(), num_rows, offsets[0] as usize)
                    .unwrap();
