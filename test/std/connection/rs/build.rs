...
fn main() {
    ...
    // Re-run this build script if the pil file changes or the autogenerated files change
    println!("cargo:rerun-if-changed={}", root_path.join("test/std/connection/connection.pil").display());
    println!("cargo:rerun-if-changed={}", root_path.join("test/std/connection/src/pil_helpers").display());
    println!("cargo:rerun-if-changed={}", root_path.join("test/std/connection/build").display());
