...
use zisklib::{
    ...
    checked_square256, checked_sub256, div_ceil256, div_rem256, inv_mod256, inv256, keccak256,
    mul_mod256, overflowing_add256, overflowing_mul256, overflowing_pow256, pow_mod256,
    reduce_mod256, saturating_pow256, saturating_sub256, secp256k1_ecdsa_recover,
    secp256k1_ecdsa_verify, secp256k1_schnorr_verify, secp256r1_ecdsa_verify, sha256,
    square_mod256, wrapping_add256, wrapping_mul256, wrapping_neg256, wrapping_pow256,
    wrapping_rem256, wrapping_square256, wrapping_sub256, ziskos_add,
};
...
fn main() {
    ...
    ziskos::io::commit(&ok);
    println!(
        "add=0x{sum:x} keccak(empty)={empty_ok} keccak(144B)={big_ok} keccak(13B)={odd_ok} sha256={sha_ok} blake2b={blake2b_ok} inv256={inv_ok} noinv={noinv_ok} addsub={addsub_ok} mul={mul_ok} div={div_ok} mod={mod_ok} invmod={invmod_ok} pow={pow_ok} k1_ecdsa={k1_ecdsa_ok} k1_recover={k1_recover_ok} k1_schnorr={k1_schnorr_ok} r1_ecdsa={r1_ecdsa_ok} => ok={ok}"
    );
}
