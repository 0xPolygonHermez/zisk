...
// PROOF ORCHESTRATOR
// ================================================================================================
pub struct ProofOrchestrator<T: Default> {
    name: String,
    initialized: bool,
    options: Options,
...
#[allow(dead_code)]
impl<T: Default + std::fmt::Debug> ProofOrchestrator<T> {
    pub fn new() -> Self {
        ProofOrchestrator {
            name: String::from("ProofOrch "),
            initialized: false,
            options: Options::default(),
            wc_manager: WitnessCalculatorManager::<T>::new(),
            proof_ctx: Arc::new(RwLock::new(ProofCtx::<T>::new())),
        }
    }
    ...
    pub fn initialize(
        ...
        self.wc_manager
            .initialize(Arc::clone(&self.proof_ctx), witness_calculators);
