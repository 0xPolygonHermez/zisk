...
fn test_trace_air_context() {
    ...
    trace_layout.add_column(
        "fixed.L1".to_string(),
        mem::size_of::<CubeExtension<BaseElement>>(),
    );
    trace_layout.add_column(
        "fixed.LLAST".to_string(),
        mem::size_of::<CubeExtension<BaseElement>>(),
    );
    ...
    trace_air_context.set_column_u8(
        "witness.a",
        witness_a.len(),
