    ...
    switch (inst & 0x7F)
    {
        ...
        case 67 : { // Opcode 67
            switch ((inst >> 25) & 0x3) {
                ...
                default: //_ => panic!("Rvd::decode_32() invalid funct3 for opcode 67 inst=0x{inst:x}"),
                    FLOAT_ASSERT(false);
                    break;
            }
            break;
        ...
        case 71 : { // Opcode 71
            switch ((inst >> 25) & 0x3) {
                ...
                default: //_ => panic!("Rvd::decode_32() invalid funct3 for opcode 71 inst=0x{inst:x}"),
                    FLOAT_ASSERT(false);
                    break;
            }
            break;
        ...
        case 75 : { // Opcode 75
            switch ((inst >> 25) & 0x3) {
                ...
                default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 75 inst=0x{inst:x}"),
                    FLOAT_ASSERT(false);
                    break;
            }
            break;
        ...
        case 79 : { // Opcode 79
            switch ((inst >> 25) & 0x3) {
                ...
                default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 79 inst=0x{inst:x}"),
                    FLOAT_ASSERT(false);
                    break;
            }
            break;
            ...
            switch ((inst >> 25) & 0x7F) {
                ...
                case 16 : {
                    switch ((inst >> 12) & 0x7) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=16 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 17 : {
                    switch ((inst >> 12) & 0x7) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=17 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 20 : {
                    switch ((inst >> 12) & 0x7) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=20 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 21 : {
                    switch ((inst >> 12) & 0x7) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=21 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 32 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=32 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 33 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=33 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 44 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=44 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 45 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=45 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 80 : {
                    switch ((inst >> 12) & 0x7) {
                        ...
                        default: // => panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=80 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 81 : {
                    switch ((inst >> 12) & 0x7) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=81 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 96: {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=96 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 97 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: // => panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=97 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 104 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: //=> panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=104 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                ...
                case 105 : {
                    switch ((inst >> 20) & 0x1F) {
                        ...
                        default: // => panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=105 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                    ...
                    switch ((inst >> 12) & 0x7) {
                        case 0 : {
                            switch ((inst >> 20) & 0x1F) {
                                ...
                                default: // panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=112 funct3=0 inst=0x{inst:x}"),
                                    FLOAT_ASSERT(false);
                                    break;
                            }
                            break;
                        ...
                        */
                        ...
                        default: //_ => panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=112 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                        ...
                        */
                        case 1 : {
                            switch ((inst >> 20) & 0x1F) {
                                ...
                                default: // panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=113 funct3=0 inst=0x{inst:x}"),
                                    FLOAT_ASSERT(false);
                                    break;
                            }
                            break;
                        }
                        default: // panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=112 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                    ...
                    switch ((inst >> 12) & 0x7) {
                        case 0 : {
                            switch ((inst >> 20) & 0x1F) {
                                ...
                                default: // panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=120 funct3=0 inst=0x{inst:x}"),
                                    FLOAT_ASSERT(false);
                                    break;
                            }
                            break;
                        }
                        default: // panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=120 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                    ...
                    switch ((inst >> 12) & 0x7) {
                        case 0 : {
                            switch ((inst >> 20) & 0x1F) {
                                ...
                                default: // panic!("Rvd::decode_32() invalid rm for opcode 83 funct7=121 funct3=0 inst=0x{inst:x}"),
                                    FLOAT_ASSERT(false);
                                    break;
                            }
                            break;
                        }
                        default: // panic!("Rvd::decode_32() invalid funct3 for opcode 83 funct7=121 inst=0x{inst:x}"),
                            FLOAT_ASSERT(false);
                            break;
                    }
                    break;
                }
                default: // panic!("Rvd::decode_32() invalid funct7 for opcode 83 inst=0x{inst:x}"),
                    FLOAT_ASSERT(false);
                    break;
            }
        }
