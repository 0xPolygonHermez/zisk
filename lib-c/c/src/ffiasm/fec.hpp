...
extern "C" int Fec_rawIsEq(FecRawElement const pRawA, const FecRawElement pRawB);
extern "C" int Fec_rawIsZero(const FecRawElement pRawB);
extern "C" void Fec_rawShl(FecRawElement r, FecRawElement a, uint64_t b);
extern "C" void Fec_rawShr(FecRawElement r, FecRawElement a, uint64_t b);
...
extern "C" void Fec_rawCopyS2L(FecRawElement pRawResult, int64_t val);
extern "C" void Fec_rawAddLS(FecRawElement pRawResult, FecRawElement pRawA, uint64_t rawB);
extern "C" void Fec_rawSubSL(FecRawElement pRawResult, uint64_t rawA, FecRawElement pRawB);
extern "C" void Fec_rawSubLS(FecRawElement pRawResult, FecRawElement pRawA, uint64_t rawB);
extern "C" void Fec_rawNegLS(FecRawElement pRawResult, FecRawElement pRawA, uint64_t rawB);
extern "C" int  Fec_rawCmp(FecRawElement pRawA, FecRawElement pRawB);
extern "C" void Fec_rawAnd(FecRawElement pRawResult, FecRawElement pRawA, FecRawElement pRawB);
extern "C" void Fec_rawOr(FecRawElement pRawResult, FecRawElement pRawA, FecRawElement pRawB);
extern "C" void Fec_rawXor(FecRawElement pRawResult, FecRawElement pRawA, FecRawElement pRawB);
extern "C" void Fec_rawShl(FecRawElement r, FecRawElement a, uint64_t b);
extern "C" void Fec_rawShr(FecRawElement r, FecRawElement a, uint64_t b);
extern "C" void Fec_rawNot(FecRawElement pRawResult, FecRawElement pRawA);
extern "C" void Fec_rawSubRegular(FecRawElement pRawResult, FecRawElement pRawA, FecRawElement pRawB);
