...
pub const ARITH_256_X_LARGE_INSTANCE_COST: usize = 3195;

/// `ArithSecp256K1`: 1.84 GB.
pub const ARITH_SECP_256_K_1_INSTANCE_COST: usize = 1884;

/// `ArithSecp256K1Large`: 3.68 GB.
pub const ARITH_SECP_256_K_1_LARGE_INSTANCE_COST: usize = 3768;

/// `ArithBn254`: 1.93 GB.
pub const ARITH_BN_254_INSTANCE_COST: usize = 1976;

/// `ArithBn254Large`: 3.87 GB.
pub const ARITH_BN_254_LARGE_INSTANCE_COST: usize = 3963;

/// `ArithEq384`: 0.98 GB.
pub const ARITH_EQ_384_INSTANCE_COST: usize = 1004;

/// `ArithEq384Large`: 1.96 GB.
pub const ARITH_EQ_384_LARGE_INSTANCE_COST: usize = 2007;
