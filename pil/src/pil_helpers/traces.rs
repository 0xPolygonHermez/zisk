...
pub const PILOUT_HASH: &str = "b0ee0d555a269bba5e53397bd8826320846bf9bd069247cf979bb7ae328143e9";
...
pub const MEM_LARGE_AIR_IDS: &[usize] = &[3];

pub const MEM_HUGE_AIR_IDS: &[usize] = &[4];
...
pub const MEM_ALIGN_LARGE_AIR_IDS: &[usize] = &[8];

pub const MEM_ALIGN_BYTE_AIR_IDS: &[usize] = &[9];

pub const MEM_ALIGN_READ_BYTE_AIR_IDS: &[usize] = &[10];

pub const MEM_ALIGN_WRITE_BYTE_AIR_IDS: &[usize] = &[11];

pub const MEM_ALIGN_BYTE_LARGE_AIR_IDS: &[usize] = &[12];

pub const MEM_ALIGN_READ_BYTE_LARGE_AIR_IDS: &[usize] = &[13];

pub const ARITH_AIR_IDS: &[usize] = &[14];

pub const BINARY_AIR_IDS: &[usize] = &[15];

pub const BINARY_LARGE_AIR_IDS: &[usize] = &[16];

pub const BINARY_HUGE_AIR_IDS: &[usize] = &[17];

pub const BINARY_ADD_AIR_IDS: &[usize] = &[18];

pub const BINARY_ADD_LARGE_AIR_IDS: &[usize] = &[19];

pub const BINARY_ADD_HUGE_AIR_IDS: &[usize] = &[20];

pub const BINARY_ADD_HI_AIR_IDS: &[usize] = &[21];

pub const BINARY_ADD_HI_LARGE_AIR_IDS: &[usize] = &[22];

pub const BINARY_ADD_HI_HUGE_AIR_IDS: &[usize] = &[23];

pub const BINARY_EXTENSION_AIR_IDS: &[usize] = &[24];

pub const BINARY_EXTENSION_LARGE_AIR_IDS: &[usize] = &[25];

pub const BINARY_EXTENSION_HUGE_AIR_IDS: &[usize] = &[26];
...
pub const ARITH_256_X_AIR_IDS: &[usize] = &[30];

pub const ARITH_256_X_LARGE_AIR_IDS: &[usize] = &[31];

pub const ARITH_SECP_256_K_1_AIR_IDS: &[usize] = &[32];

pub const ARITH_SECP_256_K_1_LARGE_AIR_IDS: &[usize] = &[33];

pub const ARITH_BN_254_AIR_IDS: &[usize] = &[34];

pub const ARITH_BN_254_LARGE_AIR_IDS: &[usize] = &[35];

pub const ARITH_EQ_384_AIR_IDS: &[usize] = &[36];

pub const ARITH_EQ_384_LARGE_AIR_IDS: &[usize] = &[37];
...
trace_row!(MemTraceRow<F> {
 addr:[ubit(29); 1], step:[ubit(38); 1], sel:[bit; 1], addr_changes:[bit; 1], step_dual:[ubit(38); 1], sel_dual:[bit; 1], value:[[u32; 2]; 1], wr:[bit; 1], previous_step:[ubit(40); 1], l_increment:[ubit(22); 1], h_increment:[u16; 1], read_same_addr:[bit; 1],
});

pub type MemTrace<R> = GenericTrace<R, 4194304, 0, 2>;

trace_row!(MemLargeFixedRow<F> {
 __L1__: F,
});
pub type MemLargeFixed<F> = GenericTrace<MemLargeFixedRow<F>, 4194304, 0, 3>;

trace_row!(MemLargeTraceRow<F> {
...
pub type MemLargeTrace<R> = GenericTrace<R, 4194304, 0, 3>;

trace_row!(MemHugeFixedRow<F> {
 __L1__: F,
});
pub type MemHugeFixed<F> = GenericTrace<MemHugeFixedRow<F>, 4194304, 0, 4>;

trace_row!(MemHugeTraceRow<F> {
...
pub type MemHugeTrace<R> = GenericTrace<R, 4194304, 0, 4>;

trace_row!(InputDataFixedRow<F> {
 __L1__: F,
});
pub type InputDataFixed<F> = GenericTrace<InputDataFixedRow<F>, 4194304, 0, 5>;
...
pub type InputDataTrace<R> = GenericTrace<R, 4194304, 0, 5>;

trace_row!(RomDataFixedRow<F> {
 __L1__: F,
});
pub type RomDataFixed<F> = GenericTrace<RomDataFixedRow<F>, 4194304, 0, 6>;

trace_row!(RomDataTraceRow<F> {
 addr_change:[bit; 2], addr:[ubit(29); 2], step:[ubit(40); 2], value:[[u32; 2]; 2],
});

pub type RomDataTrace<R> = GenericTrace<R, 4194304, 0, 6>;

trace_row!(MemAlignFixedRow<F> {
 __L1__: F,
});
pub type MemAlignFixed<F> = GenericTrace<MemAlignFixedRow<F>, 2097152, 0, 7>;
...
pub type MemAlignTrace<R> = GenericTrace<R, 2097152, 0, 7>;

trace_row!(MemAlignLargeFixedRow<F> {
 __L1__: F,
});
pub type MemAlignLargeFixed<F> = GenericTrace<MemAlignLargeFixedRow<F>, 8388608, 0, 8>;

trace_row!(MemAlignLargeTraceRow<F> {
 addr:ubit(29), offset:ubit(3), width:ubit(4), wr:bit, pc:u8, reset:bit, sel_up_to_down:bit, sel_down_to_up:bit, is_non_aligned_op:bit, sel_w_lt8:bit, sel_w_lt4:bit, sel_w_lt2:bit, reg:[u8; 8], sel:[bit; 8], step:ubit(40), delta_addr:u64, value:[u32; 2],
});

pub type MemAlignLargeTrace<R> = GenericTrace<R, 8388608, 0, 8>;

trace_row!(MemAlignByteFixedRow<F> {
 __L1__: F,
});
pub type MemAlignByteFixed<F> = GenericTrace<MemAlignByteFixedRow<F>, 4194304, 0, 9>;
...
pub type MemAlignByteTrace<R> = GenericTrace<R, 4194304, 0, 9>;

trace_row!(MemAlignReadByteFixedRow<F> {
 __L1__: F,
});
pub type MemAlignReadByteFixed<F> = GenericTrace<MemAlignReadByteFixedRow<F>, 4194304, 0, 10>;
...
pub type MemAlignReadByteTrace<R> = GenericTrace<R, 4194304, 0, 10>;

trace_row!(MemAlignWriteByteFixedRow<F> {
 __L1__: F,
});
pub type MemAlignWriteByteFixed<F> = GenericTrace<MemAlignWriteByteFixedRow<F>, 4194304, 0, 11>;
...
pub type MemAlignWriteByteTrace<R> = GenericTrace<R, 4194304, 0, 11>;

trace_row!(MemAlignByteLargeFixedRow<F> {
 __L1__: F,
});
pub type MemAlignByteLargeFixed<F> = GenericTrace<MemAlignByteLargeFixedRow<F>, 8388608, 0, 12>;

trace_row!(MemAlignByteLargeTraceRow<F> {
 sel_high_4b:bit, sel_high_2b:bit, sel_high_b:bit, direct_value:u32, composed_value:u32, written_composed_value:u32, written_byte_value:u8, value_16b:u16, value_8b:u8, byte_value:u8, addr_w:ubit(29), step:ubit(40), is_write:bit, mem_write_values:[u32; 2], bus_byte:u8,
});

pub type MemAlignByteLargeTrace<R> = GenericTrace<R, 8388608, 0, 12>;

trace_row!(MemAlignReadByteLargeFixedRow<F> {
 __L1__: F,
});
pub type MemAlignReadByteLargeFixed<F> = GenericTrace<MemAlignReadByteLargeFixedRow<F>, 8388608, 0, 13>;

trace_row!(MemAlignReadByteLargeTraceRow<F> {
 sel_high_4b:bit, sel_high_2b:bit, sel_high_b:bit, direct_value:u32, composed_value:u32, value_16b:u16, value_8b:u8, byte_value:u8, addr_w:ubit(29), step:ubit(40),
});

pub type MemAlignReadByteLargeTrace<R> = GenericTrace<R, 8388608, 0, 13>;

trace_row!(ArithFixedRow<F> {
 __L1__: F,
});
pub type ArithFixed<F> = GenericTrace<ArithFixedRow<F>, 2097152, 0, 14>;
...
pub type ArithTrace<R> = GenericTrace<R, 2097152, 0, 14>;

trace_row!(BinaryFixedRow<F> {
 __L1__: F,
});
pub type BinaryFixed<F> = GenericTrace<BinaryFixedRow<F>, 4194304, 0, 15>;
...
pub type BinaryTrace<R> = GenericTrace<R, 4194304, 0, 15>;

trace_row!(BinaryLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryLargeFixed<F> = GenericTrace<BinaryLargeFixedRow<F>, 4194304, 0, 16>;
...
pub type BinaryLargeTrace<R> = GenericTrace<R, 4194304, 0, 16>;

trace_row!(BinaryHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryHugeFixed<F> = GenericTrace<BinaryHugeFixedRow<F>, 4194304, 0, 17>;
...
pub type BinaryHugeTrace<R> = GenericTrace<R, 4194304, 0, 17>;

trace_row!(BinaryAddFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddFixed<F> = GenericTrace<BinaryAddFixedRow<F>, 4194304, 0, 18>;

trace_row!(BinaryAddTraceRow<F> {
 a:[[u32; 2]; 1], b:[[u32; 2]; 1], c_chunks:[[u16; 4]; 1], cout:[[bit; 2]; 1], sel_sh3add:[bit; 1],
});

pub type BinaryAddTrace<R> = GenericTrace<R, 4194304, 0, 18>;

trace_row!(BinaryAddLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddLargeFixed<F> = GenericTrace<BinaryAddLargeFixedRow<F>, 4194304, 0, 19>;

trace_row!(BinaryAddLargeTraceRow<F> {
 a:[[u32; 2]; 2], b:[[u32; 2]; 2], c_chunks:[[u16; 4]; 2], cout:[[bit; 2]; 2], sel_sh3add:[bit; 2],
});

pub type BinaryAddLargeTrace<R> = GenericTrace<R, 4194304, 0, 19>;

trace_row!(BinaryAddHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHugeFixed<F> = GenericTrace<BinaryAddHugeFixedRow<F>, 4194304, 0, 20>;

trace_row!(BinaryAddHugeTraceRow<F> {
 a:[[u32; 2]; 4], b:[[u32; 2]; 4], c_chunks:[[u16; 4]; 4], cout:[[bit; 2]; 4], sel_sh3add:[bit; 4],
});

pub type BinaryAddHugeTrace<R> = GenericTrace<R, 4194304, 0, 20>;

trace_row!(BinaryAddHiFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHiFixed<F> = GenericTrace<BinaryAddHiFixedRow<F>, 4194304, 0, 21>;

trace_row!(BinaryAddHiTraceRow<F> {
 a:[u32; 2], b:[u32; 2], c_chunks:[[u16; 2]; 2], sel_b_hi_is_ff:[bit; 2], sel_sh3add:[bit; 2],
});

pub type BinaryAddHiTrace<R> = GenericTrace<R, 4194304, 0, 21>;

trace_row!(BinaryAddHiLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHiLargeFixed<F> = GenericTrace<BinaryAddHiLargeFixedRow<F>, 4194304, 0, 22>;

trace_row!(BinaryAddHiLargeTraceRow<F> {
 a:[u32; 4], b:[u32; 4], c_chunks:[[u16; 2]; 4], sel_b_hi_is_ff:[bit; 4], sel_sh3add:[bit; 4],
});

pub type BinaryAddHiLargeTrace<R> = GenericTrace<R, 4194304, 0, 22>;

trace_row!(BinaryAddHiHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHiHugeFixed<F> = GenericTrace<BinaryAddHiHugeFixedRow<F>, 4194304, 0, 23>;

trace_row!(BinaryAddHiHugeTraceRow<F> {
 a:[u32; 8], b:[u32; 8], c_chunks:[[u16; 2]; 8], sel_b_hi_is_ff:[bit; 8], sel_sh3add:[bit; 8],
});

pub type BinaryAddHiHugeTrace<R> = GenericTrace<R, 4194304, 0, 23>;
...
pub type BinaryExtensionLargeFixed<F> = GenericTrace<BinaryExtensionLargeFixedRow<F>, 4194304, 0, 25>;
...
pub type BinaryExtensionLargeTrace<R> = GenericTrace<R, 4194304, 0, 25>;

trace_row!(BinaryExtensionHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryExtensionHugeFixed<F> = GenericTrace<BinaryExtensionHugeFixedRow<F>, 4194304, 0, 26>;
...
pub type BinaryExtensionHugeTrace<R> = GenericTrace<R, 4194304, 0, 26>;
...
pub type ArithEqLargeFixed<F> = GenericTrace<ArithEqLargeFixedRow<F>, 8388608, 0, 29>;

trace_row!(ArithEqLargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_arith256:bit, arith256_clk0:bit, sel_arith256_mod:bit, arith256_mod_clk0:bit, sel_secp256k1_add:bit, secp256k1_add_clk0:bit, sel_secp256k1_dbl:bit, secp256k1_dbl_clk0:bit, sel_bn254_curve_add:bit, bn254_curve_add_clk0:bit, sel_bn254_curve_dbl:bit, bn254_curve_dbl_clk0:bit, sel_bn254_complex_add:bit, bn254_complex_add_clk0:bit, sel_bn254_complex_sub:bit, bn254_complex_sub_clk0:bit, sel_bn254_complex_mul:bit, bn254_complex_mul_clk0:bit, sel_secp256r1_add:bit, secp256r1_add_clk0:bit, sel_secp256r1_dbl:bit, secp256r1_dbl_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithEqLargeTrace<R> = GenericTrace<R, 8388608, 0, 29>;

trace_row!(Arith256XFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type Arith256XFixed<F> = GenericTrace<Arith256XFixedRow<F>, 1048576, 0, 30>;
...
pub type Arith256XTrace<R> = GenericTrace<R, 1048576, 0, 30>;

trace_row!(Arith256XLargeFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type Arith256XLargeFixed<F> = GenericTrace<Arith256XLargeFixedRow<F>, 4194304, 0, 31>;

trace_row!(Arith256XLargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), sel_arith256:bit, arith256_clk0:bit, sel_arith256_mod:bit, arith256_mod_clk0:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 1], step_addr:ubit(40),
});

pub type Arith256XLargeTrace<R> = GenericTrace<R, 4194304, 0, 31>;

trace_row!(ArithSecp256K1FixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithSecp256K1Fixed<F> = GenericTrace<ArithSecp256K1FixedRow<F>, 1048576, 0, 32>;
...
pub type ArithSecp256K1Trace<R> = GenericTrace<R, 1048576, 0, 32>;

trace_row!(ArithSecp256K1LargeFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithSecp256K1LargeFixed<F> = GenericTrace<ArithSecp256K1LargeFixedRow<F>, 4194304, 0, 33>;

trace_row!(ArithSecp256K1LargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_secp256k1_add:bit, secp256k1_add_clk0:bit, sel_secp256k1_dbl:bit, secp256k1_dbl_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithSecp256K1LargeTrace<R> = GenericTrace<R, 4194304, 0, 33>;

trace_row!(ArithBn254FixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithBn254Fixed<F> = GenericTrace<ArithBn254FixedRow<F>, 1048576, 0, 34>;
...
pub type ArithBn254Trace<R> = GenericTrace<R, 1048576, 0, 34>;

trace_row!(ArithBn254LargeFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithBn254LargeFixed<F> = GenericTrace<ArithBn254LargeFixedRow<F>, 4194304, 0, 35>;

trace_row!(ArithBn254LargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_bn254_curve_add:bit, bn254_curve_add_clk0:bit, sel_bn254_curve_dbl:bit, bn254_curve_dbl_clk0:bit, sel_bn254_complex_add:bit, bn254_complex_add_clk0:bit, sel_bn254_complex_sub:bit, bn254_complex_sub_clk0:bit, sel_bn254_complex_mul:bit, bn254_complex_mul_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithBn254LargeTrace<R> = GenericTrace<R, 4194304, 0, 35>;

trace_row!(ArithEq384FixedRow<F> {
 FIRST_CLK: F, __L1__: F,
});
pub type ArithEq384Fixed<F> = GenericTrace<ArithEq384FixedRow<F>, 1048576, 0, 36>;
...
pub type ArithEq384Trace<R> = GenericTrace<R, 1048576, 0, 36>;

trace_row!(ArithEq384LargeFixedRow<F> {
 FIRST_CLK: F, __L1__: F,
});
pub type ArithEq384LargeFixed<F> = GenericTrace<ArithEq384LargeFixedRow<F>, 4194304, 0, 37>;

trace_row!(ArithEq384LargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_op:[bit; 6], sel_op_clk0:[bit; 6], x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithEq384LargeTrace<R> = GenericTrace<R, 4194304, 0, 37>;
...
values!(MemLargeAirValues<F> {
 segment_id: F, is_first_segment: F, is_last_segment: F, previous_segment_value: [F; 2], previous_segment_step: F, previous_segment_addr: F, segment_last_value: [F; 2], segment_last_step: F, segment_last_addr: F, distance_base: [F; 2], distance_end: [F; 2], im_direct: [FieldExtension<F>; 6],
});

values!(MemHugeAirValues<F> {
 segment_id: F, is_first_segment: F, is_last_segment: F, previous_segment_value: [F; 2], previous_segment_step: F, previous_segment_addr: F, segment_last_value: [F; 2], segment_last_step: F, segment_last_addr: F, distance_base: [F; 2], distance_end: [F; 2], im_direct: [FieldExtension<F>; 6],
});
...
values!(MemLargeAirGroupValues<F> {
 gsum_result: FieldExtension<F>,
});

values!(MemHugeAirGroupValues<F> {
 gsum_result: FieldExtension<F>,
});
...
pub const AIR_NAMES: &[(usize, usize, &str)] = &[
    ...
    (0, 8, "MemAlignLarge"),
    (0, 9, "MemAlignByte"),
    (0, 10, "MemAlignReadByte"),
    (0, 11, "MemAlignWriteByte"),
    (0, 12, "MemAlignByteLarge"),
    (0, 13, "MemAlignReadByteLarge"),
    (0, 14, "Arith"),
    (0, 15, "Binary"),
    (0, 16, "BinaryLarge"),
    (0, 17, "BinaryHuge"),
    ...
    (0, 20, "BinaryAddHuge"),
    (0, 21, "BinaryAddHi"),
    (0, 22, "BinaryAddHiLarge"),
    (0, 23, "BinaryAddHiHuge"),
    (0, 24, "BinaryExtension"),
    (0, 25, "BinaryExtensionLarge"),
    (0, 26, "BinaryExtensionHuge"),
    (0, 27, "Add256"),
    (0, 28, "ArithEq"),
    (0, 29, "ArithEqLarge"),
    (0, 30, "Arith256X"),
    (0, 31, "Arith256XLarge"),
    (0, 32, "ArithSecp256K1"),
    (0, 33, "ArithSecp256K1Large"),
    (0, 34, "ArithBn254"),
    (0, 35, "ArithBn254Large"),
    (0, 36, "ArithEq384"),
    (0, 37, "ArithEq384Large"),
    (0, 38, "BabyJubJub"),
    (0, 39, "Keccakf"),
    (0, 40, "Sha256f"),
    (0, 41, "Poseidon"),
