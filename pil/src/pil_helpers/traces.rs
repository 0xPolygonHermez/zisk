...
pub const PILOUT_HASH: &str = "2a13e938c5fb56dfd27860c3ec3e460e33fb8b9cd1435fe8e1789c1915ee5fae";
...
pub const FREQUENT_OPS_AIR_IDS: &[usize] = &[7];
...
pub const BINARY_ADD_AIR_IDS: &[usize] = &[12];
...
pub const ARITH_EQ_LT_TABLE_AIR_IDS: &[usize] = &[17];

pub const KECCAKF_AIR_IDS: &[usize] = &[18];

pub const KECCAKF_TABLE_AIR_IDS: &[usize] = &[19];
...
trace!(FrequentOpsFixed<F> {
 OP: F, A: [F; 2], B: [F; 2], C: [F; 2], FLAG: F, __L1__: F,
},  0, 7, 16777216 );

trace!(FrequentOpsTrace<F> {
 multiplicity: F,
},  0, 7, 16777216 );
...
values!(FrequentOpsAirGroupValues<F> {
 gsum_result: FieldExtension<F>,
});
