...
pub const PILOUT_HASH: &str = "0afbde1489680344c172d7c2da8c005896549b4ca3ed85c698c91445249011d7";
...
pub const BINARY_LARGE_AIR_IDS: &[usize] = &[15];

pub const BINARY_HUGE_AIR_IDS: &[usize] = &[16];

pub const BINARY_ADD_AIR_IDS: &[usize] = &[17];

pub const BINARY_ADD_LARGE_AIR_IDS: &[usize] = &[18];

pub const BINARY_ADD_HUGE_AIR_IDS: &[usize] = &[19];

pub const BINARY_ADD_HI_AIR_IDS: &[usize] = &[20];

pub const BINARY_ADD_HI_LARGE_AIR_IDS: &[usize] = &[21];

pub const BINARY_ADD_HI_HUGE_AIR_IDS: &[usize] = &[22];

pub const BINARY_EXTENSION_AIR_IDS: &[usize] = &[23];

pub const BINARY_EXTENSION_LARGE_AIR_IDS: &[usize] = &[24];

pub const ADD_256_AIR_IDS: &[usize] = &[25];

pub const ARITH_EQ_AIR_IDS: &[usize] = &[26];

pub const ARITH_EQ_LARGE_AIR_IDS: &[usize] = &[27];

pub const ARITH_EQ_HUGE_AIR_IDS: &[usize] = &[28];

pub const ARITH_256_X_AIR_IDS: &[usize] = &[29];

pub const ARITH_256_X_LARGE_AIR_IDS: &[usize] = &[30];

pub const ARITH_SECP_256_K_1_AIR_IDS: &[usize] = &[31];

pub const ARITH_SECP_256_K_1_LARGE_AIR_IDS: &[usize] = &[32];
...
pub const DMA_WITH_PRE_POST_AIR_IDS: &[usize] = &[53];

pub const JUMP_DEST_AIR_IDS: &[usize] = &[54];

pub const VIRTUAL_TABLE_ZISK_0_AIR_IDS: &[usize] = &[55];

pub const VIRTUAL_TABLE_ZISK_1_AIR_IDS: &[usize] = &[56];
...
pub type ArithTrace<R> = GenericTrace<R, 2097152, 0, 13>;
...
pub type BinaryTrace<R> = GenericTrace<R, 4194304, 0, 14>;

trace_row!(BinaryLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryLargeFixed<F> = GenericTrace<BinaryLargeFixedRow<F>, 4194304, 0, 15>;
...
pub type BinaryLargeTrace<R> = GenericTrace<R, 4194304, 0, 15>;

trace_row!(BinaryHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryHugeFixed<F> = GenericTrace<BinaryHugeFixedRow<F>, 4194304, 0, 16>;
...
pub type BinaryHugeTrace<R> = GenericTrace<R, 4194304, 0, 16>;

trace_row!(BinaryAddFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddFixed<F> = GenericTrace<BinaryAddFixedRow<F>, 4194304, 0, 17>;

trace_row!(BinaryAddTraceRow<F> {
 a:[[u32; 2]; 1], b:[[u32; 2]; 1], c_chunks:[[u16; 4]; 1], cout:[[bit; 2]; 1], sel_sh3add:[bit; 1],
});

pub type BinaryAddTrace<R> = GenericTrace<R, 4194304, 0, 17>;

trace_row!(BinaryAddLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddLargeFixed<F> = GenericTrace<BinaryAddLargeFixedRow<F>, 4194304, 0, 18>;

trace_row!(BinaryAddLargeTraceRow<F> {
 a:[[u32; 2]; 2], b:[[u32; 2]; 2], c_chunks:[[u16; 4]; 2], cout:[[bit; 2]; 2], sel_sh3add:[bit; 2],
});

pub type BinaryAddLargeTrace<R> = GenericTrace<R, 4194304, 0, 18>;

trace_row!(BinaryAddHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHugeFixed<F> = GenericTrace<BinaryAddHugeFixedRow<F>, 4194304, 0, 19>;

trace_row!(BinaryAddHugeTraceRow<F> {
 a:[[u32; 2]; 4], b:[[u32; 2]; 4], c_chunks:[[u16; 4]; 4], cout:[[bit; 2]; 4], sel_sh3add:[bit; 4],
});

pub type BinaryAddHugeTrace<R> = GenericTrace<R, 4194304, 0, 19>;

trace_row!(BinaryAddHiFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHiFixed<F> = GenericTrace<BinaryAddHiFixedRow<F>, 4194304, 0, 20>;

trace_row!(BinaryAddHiTraceRow<F> {
 a:[u32; 2], b:[u32; 2], c_chunks:[[u16; 2]; 2], sel_b_hi_is_ff:[bit; 2], sel_sh3add:[bit; 2],
});

pub type BinaryAddHiTrace<R> = GenericTrace<R, 4194304, 0, 20>;

trace_row!(BinaryAddHiLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHiLargeFixed<F> = GenericTrace<BinaryAddHiLargeFixedRow<F>, 4194304, 0, 21>;

trace_row!(BinaryAddHiLargeTraceRow<F> {
 a:[u32; 4], b:[u32; 4], c_chunks:[[u16; 2]; 4], sel_b_hi_is_ff:[bit; 4], sel_sh3add:[bit; 4],
});

pub type BinaryAddHiLargeTrace<R> = GenericTrace<R, 4194304, 0, 21>;

trace_row!(BinaryAddHiHugeFixedRow<F> {
 __L1__: F,
});
pub type BinaryAddHiHugeFixed<F> = GenericTrace<BinaryAddHiHugeFixedRow<F>, 4194304, 0, 22>;

trace_row!(BinaryAddHiHugeTraceRow<F> {
 a:[u32; 8], b:[u32; 8], c_chunks:[[u16; 2]; 8], sel_b_hi_is_ff:[bit; 8], sel_sh3add:[bit; 8],
});

pub type BinaryAddHiHugeTrace<R> = GenericTrace<R, 4194304, 0, 22>;

trace_row!(BinaryExtensionFixedRow<F> {
 __L1__: F,
});
pub type BinaryExtensionFixed<F> = GenericTrace<BinaryExtensionFixedRow<F>, 4194304, 0, 23>;
...
pub type BinaryExtensionTrace<R> = GenericTrace<R, 4194304, 0, 23>;

trace_row!(BinaryExtensionLargeFixedRow<F> {
 __L1__: F,
});
pub type BinaryExtensionLargeFixed<F> = GenericTrace<BinaryExtensionLargeFixedRow<F>, 4194304, 0, 24>;
...
pub type BinaryExtensionLargeTrace<R> = GenericTrace<R, 4194304, 0, 24>;
...
pub type ArithEqLargeFixed<F> = GenericTrace<ArithEqLargeFixedRow<F>, 4194304, 0, 27>;

trace_row!(ArithEqLargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_arith256:bit, arith256_clk0:bit, sel_arith256_mod:bit, arith256_mod_clk0:bit, sel_secp256k1_add:bit, secp256k1_add_clk0:bit, sel_secp256k1_dbl:bit, secp256k1_dbl_clk0:bit, sel_bn254_curve_add:bit, bn254_curve_add_clk0:bit, sel_bn254_curve_dbl:bit, bn254_curve_dbl_clk0:bit, sel_bn254_complex_add:bit, bn254_complex_add_clk0:bit, sel_bn254_complex_sub:bit, bn254_complex_sub_clk0:bit, sel_bn254_complex_mul:bit, bn254_complex_mul_clk0:bit, sel_secp256r1_add:bit, secp256r1_add_clk0:bit, sel_secp256r1_dbl:bit, secp256r1_dbl_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithEqLargeTrace<R> = GenericTrace<R, 4194304, 0, 27>;

trace_row!(ArithEqHugeFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithEqHugeFixed<F> = GenericTrace<ArithEqHugeFixedRow<F>, 8388608, 0, 28>;

trace_row!(ArithEqHugeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_arith256:bit, arith256_clk0:bit, sel_arith256_mod:bit, arith256_mod_clk0:bit, sel_secp256k1_add:bit, secp256k1_add_clk0:bit, sel_secp256k1_dbl:bit, secp256k1_dbl_clk0:bit, sel_bn254_curve_add:bit, bn254_curve_add_clk0:bit, sel_bn254_curve_dbl:bit, bn254_curve_dbl_clk0:bit, sel_bn254_complex_add:bit, bn254_complex_add_clk0:bit, sel_bn254_complex_sub:bit, bn254_complex_sub_clk0:bit, sel_bn254_complex_mul:bit, bn254_complex_mul_clk0:bit, sel_secp256r1_add:bit, secp256r1_add_clk0:bit, sel_secp256r1_dbl:bit, secp256r1_dbl_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithEqHugeTrace<R> = GenericTrace<R, 8388608, 0, 28>;

trace_row!(Arith256XFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type Arith256XFixed<F> = GenericTrace<Arith256XFixedRow<F>, 1048576, 0, 29>;
...
pub type Arith256XTrace<R> = GenericTrace<R, 1048576, 0, 29>;

trace_row!(Arith256XLargeFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type Arith256XLargeFixed<F> = GenericTrace<Arith256XLargeFixedRow<F>, 8388608, 0, 30>;

trace_row!(Arith256XLargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), sel_arith256:bit, arith256_clk0:bit, sel_arith256_mod:bit, arith256_mod_clk0:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 1], step_addr:ubit(40),
});

pub type Arith256XLargeTrace<R> = GenericTrace<R, 8388608, 0, 30>;

trace_row!(ArithSecp256K1FixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithSecp256K1Fixed<F> = GenericTrace<ArithSecp256K1FixedRow<F>, 1048576, 0, 31>;
...
pub type ArithSecp256K1Trace<R> = GenericTrace<R, 1048576, 0, 31>;

trace_row!(ArithSecp256K1LargeFixedRow<F> {
 CLK_0: F, __L1__: F,
});
pub type ArithSecp256K1LargeFixed<F> = GenericTrace<ArithSecp256K1LargeFixedRow<F>, 8388608, 0, 32>;

trace_row!(ArithSecp256K1LargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_secp256k1_add:bit, secp256k1_add_clk0:bit, sel_secp256k1_dbl:bit, secp256k1_dbl_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithSecp256K1LargeTrace<R> = GenericTrace<R, 8388608, 0, 32>;
...
pub type ArithBn254LargeFixed<F> = GenericTrace<ArithBn254LargeFixedRow<F>, 8388608, 0, 34>;

trace_row!(ArithBn254LargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_bn254_curve_add:bit, bn254_curve_add_clk0:bit, sel_bn254_curve_dbl:bit, bn254_curve_dbl_clk0:bit, sel_bn254_complex_add:bit, bn254_complex_add_clk0:bit, sel_bn254_complex_sub:bit, bn254_complex_sub_clk0:bit, sel_bn254_complex_mul:bit, bn254_complex_mul_clk0:bit, x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithBn254LargeTrace<R> = GenericTrace<R, 8388608, 0, 34>;

trace_row!(ArithEq384FixedRow<F> {
 FIRST_CLK: F, __L1__: F,
});
pub type ArithEq384Fixed<F> = GenericTrace<ArithEq384FixedRow<F>, 1048576, 0, 35>;
...
pub type ArithEq384Trace<R> = GenericTrace<R, 1048576, 0, 35>;

trace_row!(ArithEq384LargeFixedRow<F> {
 FIRST_CLK: F, __L1__: F,
});
pub type ArithEq384LargeFixed<F> = GenericTrace<ArithEq384LargeFixedRow<F>, 4194304, 0, 36>;
...
pub type Dma64AlignedFixed<F> = GenericTrace<Dma64AlignedFixedRow<F>, 4194304, 0, 45>;
...
pub type Dma64AlignedTrace<R> = GenericTrace<R, 4194304, 0, 45>;
...
pub type Dma64AlignedMemSetFixed<F> = GenericTrace<Dma64AlignedMemSetFixedRow<F>, 8388608, 0, 47>;
...
pub type Dma64AlignedMemSetTrace<R> = GenericTrace<R, 8388608, 0, 47>;

trace_row!(Dma64AlignedMemFixedRow<F> {
 __L1__: F,
});
pub type Dma64AlignedMemFixed<F> = GenericTrace<Dma64AlignedMemFixedRow<F>, 8388608, 0, 48>;
...
pub type Dma64AlignedMemTrace<R> = GenericTrace<R, 8388608, 0, 48>;

trace_row!(Dma64AlignedMemLargeFixedRow<F> {
 __L1__: F,
});
pub type Dma64AlignedMemLargeFixed<F> = GenericTrace<Dma64AlignedMemLargeFixedRow<F>, 8388608, 0, 49>;

trace_row!(Dma64AlignedMemLargeTraceRow<F> {
 src64:ubit(29), seq_end:bit, previous_seq_end:bit, sel_memcpy:bit, sel_memeq:bit, sel_memset:bit, fill_byte:u8, sel_memcpy_count_load:bit, main_step:ubit(36), dst64:ubit(29), count64:u32, sel_op_from_1:[bit; 3], value:[[u32; 2]; 4], sel_op_mem_load:[bit; 4],
});

pub type Dma64AlignedMemLargeTrace<R> = GenericTrace<R, 8388608, 0, 49>;

trace_row!(Dma64AlignedMemCpyFixedRow<F> {
 __L1__: F,
});
pub type Dma64AlignedMemCpyFixed<F> = GenericTrace<Dma64AlignedMemCpyFixedRow<F>, 8388608, 0, 50>;
...
pub type Dma64AlignedMemCpyTrace<R> = GenericTrace<R, 8388608, 0, 50>;

trace_row!(DmaUnalignedFixedRow<F> {
 __L1__: F,
});
pub type DmaUnalignedFixed<F> = GenericTrace<DmaUnalignedFixedRow<F>, 4194304, 0, 51>;
...
pub type DmaUnalignedTrace<R> = GenericTrace<R, 4194304, 0, 51>;
...
pub type DmaWithPrePostFixed<F> = GenericTrace<DmaWithPrePostFixedRow<F>, 2097152, 0, 53>;
...
pub type DmaWithPrePostTrace<R> = GenericTrace<R, 2097152, 0, 53>;

trace_row!(JumpDestFixedRow<F> {
 CLOCK: F, __L1__: F,
});
pub type JumpDestFixed<F> = GenericTrace<JumpDestFixedRow<F>, 2097152, 0, 54>;
...
pub type JumpDestTrace<R> = GenericTrace<R, 2097152, 0, 54>;
...
pub type VirtualTableZisk0Fixed<F> = GenericTrace<VirtualTableZisk0FixedRow<F>, 2097152, 0, 55>;

trace_row!(VirtualTableZisk0TraceRow<F> {
 multiplicity:[F; 12],
});

pub type VirtualTableZisk0Trace<F> = GenericTrace<VirtualTableZisk0TraceRow<F>, 2097152, 0, 55>;
...
pub type VirtualTableZisk1Fixed<F> = GenericTrace<VirtualTableZisk1FixedRow<F>, 2097152, 0, 56>;

trace_row!(VirtualTableZisk1TraceRow<F> {
 multiplicity:[F; 22],
});

pub type VirtualTableZisk1Trace<F> = GenericTrace<VirtualTableZisk1TraceRow<F>, 2097152, 0, 56>;
...
pub const AIR_NAMES: &[(usize, usize, &str)] = &[
    ...
    (0, 19, "BinaryAddHuge"),
    (0, 20, "BinaryAddHi"),
    (0, 21, "BinaryAddHiLarge"),
    (0, 22, "BinaryAddHiHuge"),
    (0, 23, "BinaryExtension"),
    (0, 24, "BinaryExtensionLarge"),
    (0, 25, "Add256"),
    (0, 26, "ArithEq"),
    (0, 27, "ArithEqLarge"),
    (0, 28, "ArithEqHuge"),
    ...
    (0, 53, "DmaWithPrePost"),
    (0, 54, "JumpDest"),
    (0, 55, "VirtualTableZisk0"),
    (0, 56, "VirtualTableZisk1"),
];