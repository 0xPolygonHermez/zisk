...
pub const PILOUT_HASH: &str = "e05d3ce649cd645f66e098029e0b7cee392b544835e728858b84934bb4a6b872";
...
pub const BLAKE_2_S_AIR_IDS: &[usize] = &[29];

pub const DMA_AIR_IDS: &[usize] = &[30];

pub const DMA_MEM_CPY_AIR_IDS: &[usize] = &[31];

pub const DMA_INPUT_CPY_AIR_IDS: &[usize] = &[32];

pub const DMA_64_ALIGNED_AIR_IDS: &[usize] = &[33];

pub const DMA_64_ALIGNED_INPUT_CPY_AIR_IDS: &[usize] = &[34];

pub const DMA_64_ALIGNED_MEM_SET_AIR_IDS: &[usize] = &[35];

pub const DMA_64_ALIGNED_MEM_AIR_IDS: &[usize] = &[36];

pub const DMA_64_ALIGNED_MEM_CPY_AIR_IDS: &[usize] = &[37];

pub const DMA_UNALIGNED_AIR_IDS: &[usize] = &[38];

pub const DMA_PRE_POST_AIR_IDS: &[usize] = &[39];

pub const DMA_PRE_POST_MEM_CPY_AIR_IDS: &[usize] = &[40];

pub const DMA_PRE_POST_INPUT_CPY_AIR_IDS: &[usize] = &[41];

pub const JUMP_DEST_AIR_IDS: &[usize] = &[42];

pub const VIRTUAL_TABLE_ZISK_0_AIR_IDS: &[usize] = &[43];
...
pub type Blake2sFixed<F> = GenericTrace<Blake2sFixedRow<F>, 1048576, 0, 29>;
...
pub type Blake2sTrace<R> = GenericTrace<R, 1048576, 0, 29>;
...
pub type Dma64AlignedFixed<F> = GenericTrace<Dma64AlignedFixedRow<F>, 2097152, 0, 33>;
...
pub type Dma64AlignedTrace<R> = GenericTrace<R, 2097152, 0, 33>;
...
pub type Dma64AlignedInputCpyTrace<R> = GenericTrace<R, 2097152, 0, 34>;

trace_row!(Dma64AlignedMemSetFixedRow<F> {
 __L1__: F,
});
pub type Dma64AlignedMemSetFixed<F> = GenericTrace<Dma64AlignedMemSetFixedRow<F>, 2097152, 0, 35>;
...
pub type Dma64AlignedMemSetTrace<R> = GenericTrace<R, 2097152, 0, 35>;

trace_row!(Dma64AlignedMemFixedRow<F> {
 __L1__: F,
});
pub type Dma64AlignedMemFixed<F> = GenericTrace<Dma64AlignedMemFixedRow<F>, 2097152, 0, 36>;
...
pub type Dma64AlignedMemTrace<R> = GenericTrace<R, 2097152, 0, 36>;

trace_row!(Dma64AlignedMemCpyFixedRow<F> {
 __L1__: F,
});
pub type Dma64AlignedMemCpyFixed<F> = GenericTrace<Dma64AlignedMemCpyFixedRow<F>, 2097152, 0, 37>;
...
pub type Dma64AlignedMemCpyTrace<R> = GenericTrace<R, 2097152, 0, 37>;

trace_row!(DmaUnalignedFixedRow<F> {
 __L1__: F,
});
pub type DmaUnalignedFixed<F> = GenericTrace<DmaUnalignedFixedRow<F>, 2097152, 0, 38>;
...
pub type DmaUnalignedTrace<R> = GenericTrace<R, 2097152, 0, 38>;

trace_row!(DmaPrePostFixedRow<F> {
 __L1__: F,
});
pub type DmaPrePostFixed<F> = GenericTrace<DmaPrePostFixedRow<F>, 2097152, 0, 39>;
...
pub type DmaPrePostTrace<R> = GenericTrace<R, 2097152, 0, 39>;

trace_row!(DmaPrePostMemCpyFixedRow<F> {
 __L1__: F,
});
pub type DmaPrePostMemCpyFixed<F> = GenericTrace<DmaPrePostMemCpyFixedRow<F>, 2097152, 0, 40>;
...
pub type DmaPrePostMemCpyTrace<R> = GenericTrace<R, 2097152, 0, 40>;

trace_row!(DmaPrePostInputCpyFixedRow<F> {
 __L1__: F,
});
pub type DmaPrePostInputCpyFixed<F> = GenericTrace<DmaPrePostInputCpyFixedRow<F>, 2097152, 0, 41>;
...
pub type DmaPrePostInputCpyTrace<R> = GenericTrace<R, 2097152, 0, 41>;

trace_row!(JumpDestFixedRow<F> {
 CLOCK: F, __L1__: F,
});
pub type JumpDestFixed<F> = GenericTrace<JumpDestFixedRow<F>, 2097152, 0, 42>;
...
pub type VirtualTableZisk1Trace<F> = GenericTrace<VirtualTableZisk1TraceRow<F>, 2097152, 0, 44>;
...
pub const AIR_NAMES: &[(usize, usize, &str)] = &[
    ...
    (0, 32, "DmaInputCpy"),
    (0, 33, "Dma64Aligned"),
    (0, 34, "Dma64AlignedInputCpy"),
    (0, 35, "Dma64AlignedMemSet"),
    (0, 36, "Dma64AlignedMem"),
    (0, 37, "Dma64AlignedMemCpy"),
    (0, 38, "DmaUnaligned"),
    (0, 39, "DmaPrePost"),
    (0, 40, "DmaPrePostMemCpy"),
    (0, 41, "DmaPrePostInputCpy"),
    (0, 42, "JumpDest"),
    (0, 43, "VirtualTableZisk0"),
    (0, 44, "VirtualTableZisk1"),
];