...
pub const PILOUT_HASH: &str = "9f05437cefd3bb092d6967a5cb7ebc8e04357e3a309be47ea877617cc4eaa629";
...
pub const DMA_AIR_IDS: &[usize] = &[41];

pub const DMA_64_ALIGNED_AIR_IDS: &[usize] = &[42];

pub const DMA_64_ALIGNED_LARGE_AIR_IDS: &[usize] = &[43];

pub const DMA_64_ALIGNED_MEM_SET_AIR_IDS: &[usize] = &[44];

pub const DMA_64_ALIGNED_MEM_AIR_IDS: &[usize] = &[45];

pub const DMA_64_ALIGNED_MEM_LARGE_AIR_IDS: &[usize] = &[46];

pub const DMA_64_ALIGNED_MEM_CPY_AIR_IDS: &[usize] = &[47];

pub const DMA_UNALIGNED_AIR_IDS: &[usize] = &[48];

pub const DMA_PRE_POST_AIR_IDS: &[usize] = &[49];

pub const JUMP_DEST_AIR_IDS: &[usize] = &[50];

pub const VIRTUAL_TABLE_ZISK_0_AIR_IDS: &[usize] = &[51];

pub const VIRTUAL_TABLE_ZISK_1_AIR_IDS: &[usize] = &[52];
...
pub type ArithEq384Fixed<F> = GenericTrace<ArithEq384FixedRow<F>, 524288, 0, 33>;
...
pub type ArithEq384Trace<R> = GenericTrace<R, 524288, 0, 33>;

trace_row!(ArithEq384LargeFixedRow<F> {
 FIRST_CLK: F, __L1__: F,
});
pub type ArithEq384LargeFixed<F> = GenericTrace<ArithEq384LargeFixedRow<F>, 1048576, 0, 34>;

trace_row!(ArithEq384LargeTraceRow<F> {
 x1:u16, y1:u16, x2:u16, y2:u16, x3:u16, y3:u16, q0:ubit(22), q1:ubit(22), q2:ubit(22), s:ubit(22), sel_op:[bit; 6], sel_op_clk0:[bit; 6], x_delta_chunk_inv:u64, x_are_different:bit, x3_lt:bit, y3_lt:bit, delta_x3:u64, delta_y3:u64, carry:[[u64; 2]; 3], step_addr:ubit(40),
});

pub type ArithEq384LargeTrace<R> = GenericTrace<R, 1048576, 0, 34>;
...
pub type DmaFixed<F> = GenericTrace<DmaFixedRow<F>, 2097152, 0, 41>;
...
pub type DmaTrace<R> = GenericTrace<R, 2097152, 0, 41>;
...
pub type Dma64AlignedLargeFixed<F> = GenericTrace<Dma64AlignedLargeFixedRow<F>, 8388608, 0, 43>;

trace_row!(Dma64AlignedLargeTraceRow<F> {
 src64:ubit(29), seq_end:bit, previous_seq_end:bit, sel_memcpy:bit, sel_memeq:bit, sel_memset:bit, fill_byte:u8, sel_memcpy_count_load:bit, sel_inputcpy:bit, main_step:ubit(36), dst64:ubit(29), count64:u32, sel_op_from_1:[bit; 3], l_value_chunks:[[u8; 2]; 4], h_value_chunks:[[ubit(24); 2]; 4], sel_op_mem_load:[bit; 4],
});

pub type Dma64AlignedLargeTrace<R> = GenericTrace<R, 8388608, 0, 43>;
...
pub type DmaPrePostFixed<F> = GenericTrace<DmaPrePostFixedRow<F>, 2097152, 0, 49>;
...
pub type DmaPrePostTrace<R> = GenericTrace<R, 2097152, 0, 49>;

trace_row!(JumpDestFixedRow<F> {
 CLOCK: F, __L1__: F,
});
pub type JumpDestFixed<F> = GenericTrace<JumpDestFixedRow<F>, 2097152, 0, 50>;
...
pub type JumpDestTrace<R> = GenericTrace<R, 2097152, 0, 50>;
...
pub type VirtualTableZisk0Fixed<F> = GenericTrace<VirtualTableZisk0FixedRow<F>, 2097152, 0, 51>;

trace_row!(VirtualTableZisk0TraceRow<F> {
 multiplicity:[F; 12],
});

pub type VirtualTableZisk0Trace<F> = GenericTrace<VirtualTableZisk0TraceRow<F>, 2097152, 0, 51>;
...
pub type VirtualTableZisk1Fixed<F> = GenericTrace<VirtualTableZisk1FixedRow<F>, 2097152, 0, 52>;

trace_row!(VirtualTableZisk1TraceRow<F> {
 multiplicity:[F; 22],
});

pub type VirtualTableZisk1Trace<F> = GenericTrace<VirtualTableZisk1TraceRow<F>, 2097152, 0, 52>;
...
pub const AIR_NAMES: &[(usize, usize, &str)] = &[
    ...
    (0, 41, "Dma"),
    (0, 42, "Dma64Aligned"),
    (0, 43, "Dma64AlignedLarge"),
    (0, 44, "Dma64AlignedMemSet"),
    (0, 45, "Dma64AlignedMem"),
    (0, 46, "Dma64AlignedMemLarge"),
    (0, 47, "Dma64AlignedMemCpy"),
    (0, 48, "DmaUnaligned"),
    (0, 49, "DmaPrePost"),
    (0, 50, "JumpDest"),
    (0, 51, "VirtualTableZisk0"),
    (0, 52, "VirtualTableZisk1"),
];