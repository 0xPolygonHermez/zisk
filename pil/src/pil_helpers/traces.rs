...
pub const PILOUT_HASH: &str = "6b9183da894d15daac6bb1269ad709b52a42ff1ed5a652414fb72535ad1d2baf";
...
trace!(VirtualTableFixed<F> {
 UID: [F; 67], column: [F; 119], __L1__: F,
},  0, 14, 2097152 );
