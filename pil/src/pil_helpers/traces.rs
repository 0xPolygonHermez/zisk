...
pub const ARITH_256_AIR_IDS: &[usize] = &[0];
...
trace!(Arith256Fixed<F> {
 CLK_0: F, CHUNK_ID: F, __L1__: F,
},  0, 0, 262144 );

trace!(Arith256Trace<F> {
 x1: F, y1: F, x2: F, y2: F, x3: F, y3: F, q0: F, q1: F, q2: F, s: F, sel_eq: [F; 6], in_use: F, sel_arith256: F, sel_arith256_mod: F, sel_secp256k1_add: F, sel_secp256k1_dbl: F, eq_arith256: [F; 2], eq_arith256_mod: [F; 2], eq_secp256k1_add: [F; 2], eq_secp256k1_dbl: [F; 2], eq_secp256k1_x3: [F; 2], eq_secp256k1_y3: [F; 2], x_delta_chunk_inv: F, x_are_different: F, lt_borrow: F, lt: F, carry: [[F; 2]; 3], step_addr: F,
},  0, 0, 262144 );
