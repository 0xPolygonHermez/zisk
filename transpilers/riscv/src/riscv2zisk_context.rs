...
use zisk_definitions::{
    ...
    SYSCALL_BLAKE2B_ROUND_ID, SYSCALL_BLAKE2S_ROUND_ID, SYSCALL_BLS12_381_COMPLEX_ADD_ID,
...
const CSR_PRECOMPILED: [&str; 30] = [
    ...
    "profile",
    "poseidon1",
    // 0x81C: jump_dest is dispatched from its own match arm and never read
    // from this table; the entry keeps the index mapping dense.
    "jump_dest",
    "blake2s",
];
