...
pub use precomp_poseidon::PoseidonSm;
...
pub mod inputs {
    ...
    pub use precomp_poseidon::PoseidonInput;
...
pub mod rows {
    pub use zisk_pil::{
        ...
        InputDataTraceRow, KeccakfTraceRow, MemAlignTraceRow, MemTraceRow, PoseidonTraceRow,
...
pub mod traces {
    pub use zisk_pil::{
        ...
        MemTrace, PoseidonTrace, RomDataTrace, Sha256fTrace,
    };
}
use proofman::{
