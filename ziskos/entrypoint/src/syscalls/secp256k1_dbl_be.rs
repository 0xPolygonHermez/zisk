//! syscall_secp256k1_dbl_be system call interception
...
/// Big-endian variant of [`syscall_secp256k1_dbl`](super::syscall_secp256k1_dbl).
///
/// Identical to `syscall_secp256k1_dbl`, except that each 256-bit coordinate of
...
#[cfg_attr(feature = "hints", export_name = "hints_syscall_secp256k1_dbl_be")]
pub extern "C" fn syscall_secp256k1_dbl_be(
    p: &mut SyscallPoint256,
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) {
    #[cfg(zisk_guest)]
    ziskos_syscall!(zisk_definitions::SYSCALL_SECP256K1_DBL_BE_ID, p);
    #[cfg(not(zisk_guest))]
    {
