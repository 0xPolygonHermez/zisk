//! Secp256k1Add (big-endian) system call interception
...
use super::secp256k1_add::SyscallSecp256k1AddParams;

/// Big-endian variant of [`syscall_secp256k1_add`](super::syscall_secp256k1_add).
///
/// Identical to `syscall_secp256k1_add`, except that each 256-bit coordinate of
...
#[cfg_attr(feature = "hints", export_name = "hints_syscall_secp256k1_add_be")]
pub extern "C" fn syscall_secp256k1_add_be(
    params: &mut SyscallSecp256k1AddParams,
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) {
    #[cfg(zisk_guest)]
    ziskos_syscall!(zisk_definitions::SYSCALL_SECP256K1_ADD_BE_ID, params);
    #[cfg(not(zisk_guest))]
    {
