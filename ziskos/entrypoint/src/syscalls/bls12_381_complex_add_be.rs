//! syscall_bls12_381_complex_add_be system call interception
...
use super::bls12_381_complex_add::SyscallBls12_381ComplexAddParams;

/// Big-endian variant of [`syscall_bls12_381_complex_add`](super::syscall_bls12_381_complex_add).
///
/// Identical to `syscall_bls12_381_complex_add`, except that each 384-bit coordinate
...
#[cfg_attr(feature = "hints", export_name = "hints_syscall_bls12_381_complex_add_be")]
pub extern "C" fn syscall_bls12_381_complex_add_be(
    params: &mut SyscallBls12_381ComplexAddParams,
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) {
    #[cfg(zisk_guest)]
    ziskos_syscall!(zisk_definitions::SYSCALL_BLS12_381_COMPLEX_ADD_BE_ID, params);
    #[cfg(not(zisk_guest))]
    {
