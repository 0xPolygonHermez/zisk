//! syscall_bn254_complex_mul_be system call interception
...
use super::bn254_complex_mul::SyscallBn254ComplexMulParams;

/// Big-endian variant of [`syscall_bn254_complex_mul`](super::syscall_bn254_complex_mul).
///
/// Identical to `syscall_bn254_complex_mul`, except that each 256-bit coordinate of
...
#[cfg_attr(feature = "hints", export_name = "hints_syscall_bn254_complex_mul_be")]
pub extern "C" fn syscall_bn254_complex_mul_be(
    params: &mut SyscallBn254ComplexMulParams,
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) {
    #[cfg(zisk_guest)]
    ziskos_syscall!(zisk_definitions::SYSCALL_BN254_COMPLEX_MUL_BE_ID, params);
    #[cfg(not(zisk_guest))]
    {
