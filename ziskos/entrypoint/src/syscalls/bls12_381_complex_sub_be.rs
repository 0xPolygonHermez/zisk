//! syscall_bls12_381_complex_sub_be system call interception
...
use super::bls12_381_complex_sub::SyscallBls12_381ComplexSubParams;

/// Big-endian variant of [`syscall_bls12_381_complex_sub`](super::syscall_bls12_381_complex_sub).
///
/// Identical to `syscall_bls12_381_complex_sub`, except that each 384-bit coordinate
...
#[cfg_attr(feature = "hints", export_name = "hints_syscall_bls12_381_complex_sub_be")]
pub extern "C" fn syscall_bls12_381_complex_sub_be(
    params: &mut SyscallBls12_381ComplexSubParams,
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) {
    #[cfg(zisk_guest)]
    ziskos_syscall!(zisk_definitions::SYSCALL_BLS12_381_COMPLEX_SUB_BE_ID, params);
    #[cfg(not(zisk_guest))]
    {
