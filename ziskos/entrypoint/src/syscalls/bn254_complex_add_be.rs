//! syscall_bn254_complex_add_be system call interception
...
use super::bn254_complex_add::SyscallBn254ComplexAddParams;

/// Big-endian variant of [`syscall_bn254_complex_add`](super::syscall_bn254_complex_add).
///
/// Identical to `syscall_bn254_complex_add`, except that each 256-bit coordinate of
...
#[cfg_attr(feature = "hints", export_name = "hints_syscall_bn254_complex_add_be")]
pub extern "C" fn syscall_bn254_complex_add_be(
    params: &mut SyscallBn254ComplexAddParams,
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) {
    #[cfg(zisk_guest)]
    ziskos_syscall!(zisk_definitions::SYSCALL_BN254_COMPLEX_ADD_BE_ID, params);
    #[cfg(not(zisk_guest))]
    {
