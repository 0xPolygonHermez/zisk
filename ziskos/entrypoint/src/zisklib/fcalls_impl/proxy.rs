//! Fcall dispatch proxy.
//!
//! Routes an fcall ID to the corresponding software implementation.

use crate::zisklib::{
    FCALL_BIGINT_DIV_ID, FCALL_BIN_DECOMP_ID, FCALL_BLS12_381_FP2_INV_ID,
    ...
    FCALL_SECP256K1_GLV_DECOMPOSE_ID, FCALL_SECP256R1_ECDSA_VERIFY_ID, FCALL_UINT256_DIV_ID,
    FCALL_UINT256_INV_ID, FCALL_UINT256_INV_MOD_ID,
};

use super::{
    bigint_div::*, bin_decomp::*, bls12_381::*, bn254::*, msb_pos_256::*, msb_pos_384::*,
    secp256k1::*, secp256r1::*, uint256::*,
};

/// Dispatches an fcall by `id`, forwarding `params` to the matching implementation and
/// writing the result into `results`. Returns the number of result limbs written, or a
/// negative error code.
pub fn fcall_proxy(id: u64, params: &[u64], results: &mut [u64]) -> i64 {
    match id as u16 {
        ...
        FCALL_UINT256_DIV_ID => fcall_uint256_div(params, results),
        FCALL_UINT256_INV_ID => fcall_uint256_inv(params, results),
        FCALL_UINT256_INV_MOD_ID => fcall_uint256_inv_mod(params, results),
        FCALL_BIGINT_DIV_ID => fcall_bigint_div(params, results),
