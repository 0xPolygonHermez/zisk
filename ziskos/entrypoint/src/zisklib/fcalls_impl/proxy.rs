use super::{
    arith256::*, bn254_fp::*, bn254_fp2::*, bn254_twist::*, msb_pos_256::*, secp256k1_fn_inv::*,
    secp256k1_fp_inv::*, secp256k1_fp_sqrt::*,
};
use crate::{
    FCALL_ARITH256_DIV_REM_ID, FCALL_BN254_FP2_INV_ID, FCALL_BN254_FP_INV_ID,
...
pub fn fcall_proxy(id: u64, params: &[u64], results: &mut [u64]) -> i64 {
    match id as u16 {
        ...
        FCALL_ARITH256_DIV_REM_ID => fcall_div_rem_256(params, results),
