use super::{
    ...
    bn254_fp::*, bn254_fp2::*, bn254_twist::*, division::*, msb_pos_256::*,
...
use crate::{
    ...
    FCALL_BN254_TWIST_DBL_LINE_COEFFS_ID, FCALL_DIVISION_ID,
...
pub fn fcall_proxy(id: u64, params: &[u64], results: &mut [u64]) -> i64 {
    match id as u16 {
        ...
        FCALL_DIVISION_ID => fcall_division(params, results),
