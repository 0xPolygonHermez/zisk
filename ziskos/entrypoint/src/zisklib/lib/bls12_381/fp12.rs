...
use super::{
    ...
    fp6::{
        ...
        neg_fp6_bls12_381, sparse_mulb_fp6_bls12_381, sparse_mulc_fp6_bls12_381,
        sparse_muld_fp6_bls12_381, square_fp6_bls12_381, sub_fp6_bls12_381,
    },
};
...
pub fn mul_fp12_bls12_381(a: &[u64; 72], b: &[u64; 72]) -> [u64; 72] {
    ...
    // c1 = a1·b1 + a2·b2·v
    let mut c1 = sparse_mulb_fp6_bls12_381(&a2_b2, &EXT_V);
...
pub fn sparse_mul_fp12_bls12_381(a: &[u64; 72], b: &[u64; 24]) -> [u64; 72] {
    ...
    let mut c1 = sparse_muld_fp6_bls12_381(a2, &[b23u, *b22].concat().try_into().unwrap());
    c1 = add_fp6_bls12_381(&c1, a1);

    // c2 = a2 + a1·(b22·v + b23·v²)
    let mut c2 = sparse_mulc_fp6_bls12_381(a1, &[*b22, *b23].concat().try_into().unwrap());
...
pub fn square_fp12_bls12_381(a: &[u64; 72]) -> [u64; 72] {
    ...
    let a2_v = sparse_mulb_fp6_bls12_381(a2, &EXT_V);
    let a1_a2_v = sparse_mulb_fp6_bls12_381(&a1_a2, &EXT_V);
...
pub fn inv_fp12_bls12_381(a: &[u64; 72]) -> [u64; 72] {
    ...
    let a2_square_v = sparse_mulb_fp6_bls12_381(&a2_square, &EXT_V);
