...
pub fn fcall_division_long(a_value: &[u64], b_value: &[u64]) -> (Vec<u64>, Vec<u64>) {
    ...
    #[cfg(all(target_os = "zkvm", target_vendor = "zisk"))]
    {
        ...
        ziskos_fcall!(FCALL_DIVISION_LONG_ID);
