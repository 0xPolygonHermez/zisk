use crate::hints::{HINT_QUEUE, check_main_thread, hint::Hint, macros::define_hint};
...
pub fn hint_pairing_batch_bn254(g1_points: Vec<[u64; 8]>, g2_points: Vec<[u64; 16]>) {
    ...
    let hint = Hint::HintPairingBatchBn254(PairingBatchBn254::new(g1_points, g2_points));
