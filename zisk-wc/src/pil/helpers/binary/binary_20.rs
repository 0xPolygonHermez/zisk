...
use wcmanager::{Ptr, TracePol};

pub struct Binary20<T> {
...
impl<T> Binary20<T> {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            z: TracePol::from_ptr(ptr_x.add::<T>(), Self::ROW_SIZE, Self::NUM_ROWS),
            w: TracePol::from_ptr(ptr_x.add::<T>(), Self::ROW_SIZE, Self::NUM_ROWS),
        }
    }
    ...
    pub fn from_ptr(ptr: *mut std::ffi::c_void, offset: usize, stride: usize) -> Self {
        ...
        Self {
            ...
            z: TracePol::from_ptr(ptr_x.add::<T>(), stride, Self::NUM_ROWS),
            w: TracePol::from_ptr(ptr_x.add::<T>(), stride, Self::NUM_ROWS),
        }
    }
}
