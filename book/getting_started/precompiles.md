...
- [syscall_keccak_f](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/keccakf.rs): Keccak-f 1600 permutation function from the [Keccak](https://keccak.team/files/Keccak-reference-3.0.pdf) cryptographic hash function.
- [syscall_sha256_f](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/sha256f.rs): Extend and compress function of the [SHA-256](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.180-4.pdf) cryptographic hash function.
- [syscall_blake2b_round](https://github.com/0xPolygonHermez/zisk/blob/main/ziskos/entrypoint/src/syscalls/blake2br.rs): Round function of the [BLAKE2b](https://blake2.net/blake2.pdf) cryptographic hash function.
- [syscall_blake2sf](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/blake2sf.rs): Permutation of the [BLAKE2s](https://www.rfc-editor.org/rfc/rfc7693.html) cryptographic hash function.
- [syscall_blake3f](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/blake3f.rs): Permutation of the [BLAKE3](https://github.com/BLAKE3-team/BLAKE3) cryptographic hash function.
- [syscall_poseidon1](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/poseidon1.rs): Compression function of the [Poseidon1](https://eprint.iacr.org/2019/458.pdf) cryptographic hash function.
- [syscall_poseidon2](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/poseidon2.rs): Compression function of the [Poseidon2](https://eprint.iacr.org/2023/323.pdf) cryptographic hash function.
...
- [syscall_babyjubjub_add](https://github.com/0xPolygonHermez/zisk/tree/main/ziskos/entrypoint/src/syscalls/babyjubjub_add.rs): Elliptic curve point addition over the [Babyjubjub](https://eips.ethereum.org/EIPS/eip-2494) curve.