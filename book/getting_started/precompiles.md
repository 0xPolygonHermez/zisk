...
- [syscall_blake2br](https://github.com/0xPolygonHermez/zisk/blob/main/ziskos/entrypoint/src/syscalls/blake2br.rs): Round function of the [BLAKE2b](https://blake2.net/blake2.pdf) cryptographic hash function.
