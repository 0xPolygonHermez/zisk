...
const MEM_AIR_IDS_MAP: &[(usize, usize)] = &[
    ...
    (ZISK_AIRGROUP_ID, COMPACT_MEM_AIR_IDS[0]),
    ...
    (ZISK_AIRGROUP_ID, COMPACT_MEM_ALIGN_AIR_IDS[0]),
    (ZISK_AIRGROUP_ID, COMPACT_MEM_ALIGN_LARGE_AIR_IDS[0]),
];
...
const DMA_AIR_IDS_MAP: &[(usize, usize)] = &[
    ...
    (ZISK_AIRGROUP_ID, DMA_WITH_PRE_POST_AIR_IDS[0]),
    ...
    (ZISK_AIRGROUP_ID, DMA_UNALIGNED_LARGE_AIR_IDS[0]),
