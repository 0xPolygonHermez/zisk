...
use zisk_pil::{
    AIR_NAMES, COMPACT_MEM_AIR_IDS, INPUT_DATA_AIR_IDS, MAIN_AIR_IDS, MEM_AIR_IDS, ROM_AIR_IDS,
...
mod tests {
    ...
    fn test_is_memory_related() {
        ...
        assert!(AirClassifier::is_memory_related(COMPACT_MEM_AIR_IDS[0]));
    }
