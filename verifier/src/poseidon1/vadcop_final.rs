...
pub fn verify(proof: &VadcopFinalProof, vk: &[u64]) -> bool {
    stark_verify::<Poseidon1_16, Poseidon1_16, Transcript<Goldilocks, Poseidon1_16>, Poseidon1_8>(&proof.proof_with_publics(), vk, &verifier_info(), q_verify)
}

pub fn verify_u64(proof: &[u64], vk: &[u64]) -> bool {
    stark_verify::<Poseidon1_16, Poseidon1_16, Transcript<Goldilocks, Poseidon1_16>, Poseidon1_8>(proof, vk, &verifier_info(), q_verify)
}
