...
impl AsmRHData {
    ...
    pub fn from_shared_memory(asm_shared_memory: &AsmSharedMemory) -> AsmRHData {
        unsafe {
            let data_ptr = asm_shared_memory.data_ptr::<AsmRHHeader>() as *mut u64;
            // BIOS chunk data
            ...
            AsmRHData {
                steps: asm_shared_memory.map_header::<AsmRHHeader>().steps,
                bios_inst_count,
                prog_inst_count,
            }
        }
